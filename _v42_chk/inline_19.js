...
/* /u1inj:data-nodes:dn_graduate.js/ */
...
"acad_life_y1_holiday_guard":["你替守夜人巡了整冬的夜。雪夜里钟楼的影子拉得很长，你把每一条走廊的灯都摸清了。有一夜，你看见一个戴金边眼镜的身影拐进灰楼，手里提着盏没点亮的灯——你记住了，没跟任何人说。"],
...
"acad_diary_fragment":["你把那半本日记又翻出来看了几页。后面几页的字迹潦草了些，有一行写着：“第七节点已渗水。他们把裂缝填了，可水是从底下渗上来的。学院里，有人替他们数着日子。”你数了数，日记里提到“第七节点”的，一共三次。"],
...
"你站在化雪的路口，雪水顺着靴缝渗进来，凉得清醒。你知道自己明年得选一条路走了——不是课程的路，是别的路。"
],options:[
...
"你看了一眼那张被划掉的字，想起费尔曼的话。四年级，是学院开始向学生打开暗门的一年。你要走进去，还是绕着走？"
],options:[
...
"grad_key_ferman":["你把那把锈钥匙放在火上烤了烤，纹路里渗出一点暗色的东西——不是锈，是干涸很久的什么东西。你把它擦了又擦，收好。禁书区那道铁门的锁孔，你比划过，尺寸对得上。"],
...
"老莫里茨教授坐在前排，比去年瘦了一圈。他看见你，招招手，你走过去，他抓住你的手，掌心干枯而热：“孩子，毕业了。有些事，我想在你还留着这身学生皮的时候，跟你说。”"
],options:[
...
"你在钟楼上最后看了一眼北边——那里有第三哨，有矿洞，有雪原，有等你去找的答案。"
],options:[
...
"你把信和铁牌放在一起，收进贴身的口袋。北边的墓园，看来得去一趟。"
],options:[
...
"有一回你改卷改到半夜，听见走廊尽头传来很轻的脚步声——那个方向，是典藏室。你披衣出去看，走廊空荡荡的，只有风从窗缝里钻进来。"
],options:[
...
"grad_key_ferman":["你夜里巡到铁门前，四下无人。你掏出费尔曼给的那把锈钥匙，对着锁孔比了比——尺寸严丝合缝。手停在半空，你想起费尔曼的话：“等你想清楚自己是谁，再决定开不开。”你收了钥匙，转身走开。门后传来一声极轻的叹息，像风，又不像风。"],
...
"你在他递来的名册上摁了手印。手印落下去的那一刻，你就不再是学生了。"
],options:[
...
"acad_kain_ideal":["报到那天，你在校场上看见了凯恩。他如今是个什长了，腰间别着把新刀，看见你，咧开嘴笑了：“我就说你会来。”他锤了你一拳，“学院里你那套拳脚，搁这儿够不够用，得练练才知道。”"]
}},options:[
...
"臂甲上有一道旧划痕，擦不掉。教官说：“那是上一任主人的。他死在北边。”"
],options:[
...
"你低头看那枚铜章。半年前你还是个学生，现在你是北境的兵。这身份换得不算亏。"
],options:[
...
"你站在荒原边界上，看远处天际线有一道紫色的光带，缓缓明灭。西境，比你听说的还要躁动。"
],options:[
...
"grad_key_ferman":["你把那把锈钥匙从怀里摸出来，放在地图上。它沉甸甸地压着地图的西北角——那个方向，是第三哨，是矿洞，是费尔曼说的那道门。游历归游历，你知道自己终究要往那个方向走一趟。"],
...
"你被簇拥着往村里走。五年前你离开时，村里人觉得你去北边念书是瞎折腾；现在，他们觉得你出息了。你笑了笑，没解释。"
],options:[
...
"这一夜，你睡回了小时候那张床。床板吱呀响，窗外有蛙鸣，一切好像没变，又好像什么都变了。"
],options:[
...
"村里炸了锅。老汉们蹲在墙根叹气，年轻媳妇抱着孩子抹眼泪。你站在人群边上，看着那个敲锣的外乡人——他腰里别着刀，眼睛却发虚。"
],options:[
...
"村里人你看我，我看你，然后爆出一阵哄笑和叫好。放牛的老汉拍着你的肩：“好小子，学的东西没白学！”"
],options:[
...
"你知道自己不会永远留在村里——外面的世界还有没走完的路。但你也不会忘记这碗米酒，和这座祠堂。这是你出发的地方。"
],options:[
