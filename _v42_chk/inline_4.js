...
function showOptions(node){
  ...
  for(let i=0;i<opts.length;i++){
    ...
    b.innerHTML = html;
    b.onclick = function(){
      if(_reqFail){ try{ if(window.flashMsg) window.flashMsg("你还不具备这个条件。"); }catch(e){} return; }
      choose(o);
    };
...
"你捡起那颗银珠。它温热，像刚出锅的糖。",
"门被推开，导师拎着酒壶进来：“怎么样？”",
"“成了。”你说。你没提那颗银珠——它正躺在你口袋里，贴着皮肤，发烫。"
],pace:"normal",
...
"只有你记得，它趴在你膝上的时候，尾巴尖扫过了扫你的手腕——像在记你的味道。"
],pace:"normal",
...
"你走出账房，太阳很好。你发现自己的手指在发烫——不是握算盘握的，是你刚才顺着那两行数字往下看的时候，心里有什么东西，像一把锁，被一串数字指尖一拨开了。"
],pace:"normal",
...
place:"静室 · 灯下",
text:["你闭着眼，把今天学的法术在脑子里过了一遍。第三遍的时候，你忽然闻见一股墨水味，很淡，像谁刚写完一页字。", "你睁开眼。房间空无一人，桌上那支没用过的羽毛笔，笔尖上凝着一滴墨，正在往下滴。", "你伸手接住。墨滴落进掌心，没有晕开，凝成一颗圆圆的珠子，像一只闭着的眼睛。", "你听见一个声音，很轻，像隔着一千年的纸传过来的：“写字的笔，认字的手。”", "珠子在你掌心化开，渗进皮肤，只留下一圈淡青色的印子。", "你闻到的墨水味散了。你摊开书，翻到扉页——上面有一行字，不是你写的：“奥术不认血缘，认的是破开真相的执念。”", "你盯着那行字。墨迹很新，像刚刚落笔。"],pace:"normal",
...
place:"静室 · 灯下",
text:["你打坐的时候，眼前总会浮起一片光。不是烛光，不是日光，像清晨第一线从天边渗进来的白，很薄，很凉。", "你睁开眼，光就散了。房间里还是那盏灯，灯芯烧得发黑。", "你闭上眼，光又回来。这一次，光里有一个模糊的影子，轮廓很淡，像在跟你说什么，但你听不见。", "你试着向前走一步。光里的影子退一步。你再走，它再退。", "你停下来。影子也停下来。它抬手，指了指你自己。", "你低头看自己——你站在一片光里，脚边有一圈淡淡的影子，形状和你一模一样。", "你睁开眼。灯还亮着。你发现自己的影子，在灯下，比平时淡了一点。"],pace:"normal",
options:[{t:"把这段感应记在心里", go:"sub_path_hub"},
...
place:"静室 · 灯下",
text:["你练刀练到力竭，靠在演武场的木桩上喘气。", "夕阳把你的影子拉得很长。你看着自己的影子，忽然觉得，那道影子比你壮——不是错觉，影子的肩，比你宽了半寸。", "你站直。影子也站直。你举起手，影子举起手。动作一致，但影子的动作，总是快你一线。", "你盯着那道影子，影子也像在看你。", "你想起一个老兵的传说：战神陨落三千年，他的战意没有散，沉在大陆的每一把刀里。握刀的人，都会梦见同一个战场。", "你低头看自己的刀。刀身上，夕阳的余光镀了一层金。", "你收刀入鞘。影子缩回你脚下。你走出演武场，脚步比来时重了一点。"],pace:"normal",
options:[{t:"把这段感应记在心里", go:"sub_path_hub"},
...
place:"静室 · 灯下",
text:["你帮教堂修整围栏时，在墙根底下刨出一块旧石碑。石碑半截埋在土里，字迹已经磨平了。", "你用水洗净碑面，发现最上面刻着一行字，笔画很浅，像刻的人故意不用力：“立誓之人，其誓不移。”", "你蹲在碑前，把那行字念了一遍。", "念完，你听见一声极轻的响，像什么东西在你胸腔里应了一声。你按住胸口，心跳很正常。", "你继续修围栏。可那行字在你脑子里转了一下午。", "傍晚，你把石碑立回墙根，用土培好。你站起来的时候，发现自己不知什么时候，把左手按在了碑面上，像在按着什么起誓。", "你收回手。碑面上，多了一个淡淡的掌印。"],pace:"normal",
options:[{t:"把这段感应记在心里", go:"sub_path_hub"},
...
place:"静室 · 灯下",
text:["你巡林的时候，在一棵老树洞里发现一窝雏鸟。鸟妈妈不在，雏鸟饿得直叫。", "你抓了几条虫，喂给它们。喂完，你发现树洞边沿，刻着一个极淡的记号，像一片叶子，又像一枚脚印。", "你顺着记号的方向走。走了一里地，记号消失了，你站在一片你从没到过的空地中央。", "空地上没有树，只有一片草，草长得整整齐齐，像被谁修剪过。", "你蹲下来摸那草。草叶是凉的，但草根是温的。", "你听见风声。风里有一个声音，不像人，像整个林子同时开口：“荒野之神不立庙，不进香。他的庙，是每条没人踩出来的路。”", "你站起来。风吹过空地，草叶一起一伏。", "你沿着来路走回树洞。雏鸟已经睡了，鸟妈妈不知什么时候回来了，正蹲在枝头看你。"],pace:"normal",
options:[{t:"把这段感应记在心里", go:"sub_path_hub"},
...
place:"静室 · 灯下",
text:["你替学院跑腿送信，路过一条你没走过的小巷。巷子很窄，墙根堆着旧物，尽头是一扇漆皮剥落的门。", "门缝里漏出一线光。你凑近看，里面不是房间，是一条向下的楼梯，光从楼梯尽头透上来。", "你没有推门。你记住了这条巷子的位置，继续送信。", "回来的时候，你故意又走了一次这条巷子。门还在，光还亮着。", "第三次，你蹲在门口，仔细看那扇门。门板上没有锁，只有一个极小的刻痕，像一只闭着的眼睛。", "你伸手摸那只眼睛。刻痕是凉的，可你指尖刚碰到，门缝里的光，晃了一下。", "你收回手。光又稳住了。你听见楼梯尽头传来一个声音，很轻，像有人笑了一下，又像没有。"],pace:"normal",
options:[{t:"把这段感应记在心里", go:"sub_path_hub"},
...
place:"静室 · 灯下",
text:["你做完晚祷，最后一个走出教堂。", "夕阳正好落在圣坛上，把圣像染成金色。你看见圣像的指尖，凝着一粒光，像一滴露水，又像一粒泪。", "你走过去看。光粒是温的，你伸手，它落在你掌心，没有化开，像一颗小小的太阳。", "你听见钟声——不是晚钟，是一声你从没听过的钟鸣，又远又近，像从云层上面传下来的。", "钟声过后，圣像的指尖，光粒消失了。你掌心那粒光，还在。", "你把它贴在胸口。它隔着衣料，发烫，像一颗跳动的心。", "走出教堂时，晚风很凉。你掌心的光，一直温着。"],pace:"normal",
options:[{t:"把这段感应记在心里", go:"sub_path_hub"},
...
place:"静室 · 灯下",
text:["你替食堂算这个月的账，算到最后，总数差了三个铜币。", "你重新算了两遍，还是差三个。你翻进货单，一笔一笔核对，最后发现——上个月的账，多记了三笔支出，每笔正好一个铜币。", "这三笔支出，不是你记的。你翻到上个月的账页，墨迹已经干了，但笔迹不对——比你写的轻，像谁在你记完账之后，添上去的。", "你把那三笔划掉，重新合计，数字对上了。", "合上账本的瞬间，你听见一声极轻的响，像秤杆在桌上顿了一下。", "你抬头。账房里只有你一个人。桌上那杆旧秤，秤砣自己摆正了，像被谁扶了一下。"],pace:"normal",
options:[{t:"把这段感应记在心里", go:"sub_path_hub"},
...
place:"火晶尘 · 仪式之约",
text:["你想起导师在元素课上说过的一句话：“火认人，也认路。你要让火走你的路，得先给火一粒它的尘。”", "风炉间的人说，炉膛里的火晶尘，每月清一次，清出来的细尘都收在炉边的陶罐里。", "那是火自己褪下的皮。用它做引子，火才会记得你的手。"],pace:"light",
...
place:"旧纸人 · 仪式之约",
text:["咒法课的前辈听说你想学召唤，笑了笑：“纸人不难画，难的是让它记住你。”", "“先找个旧纸人——画过很多次、被改过很多次的。它身上有前一个主人的笔意。”", "学院杂物间最里面的旧柜里，据说就压着一叠这样的纸人。"],pace:"light",
...
place:"静默墨 · 仪式之约",
text:["档案馆的旧结界图，落款处有一行小字：“以静默墨写印，结界方成。”", "静默墨是图书馆抄本室才有的东西——干了之后仍会渗墨，蘸它写字，笔尖不响。", "抄写员说，那墨是给抄遗书的人用的。"],pace:"light",
...
place:"骨灰 · 仪式之约",
text:["守望者的老前辈听说你在坟场练银线，没有拦你，只留下一句：“亡者之事，用亡者之物。”", "他说后山老槐树下的土，每年清明会有人去撒一把灰——那是烧给无主孤魂的。", "那灰，就是引子。"],pace:"light",
...
place:"旧钟绳 · 仪式之约",
text:["钟楼的守钟人是个哑巴，但他会写字。他在你手心写：“听钟的人，先碰过钟绳。”", "顶层那口旧钟的钟绳，换过三次，旧绳都堆在角落。", "绳上缠着一截褪色的红布——是上一任守钟人的记号。"],pace:"light",
...
place:"烛泪 · 仪式之约",
text:["医师教你的第一课不是火，是蜡：“火苗可以骗，烛泪骗不了。你看一支蜡烛烧到第几夜，就知道它有没有心事。”", "教堂清晨收烛台时，会刮下隔夜的烛泪。那泪里，凝着前一晚所有祈祷的重量。", "用隔夜的烛泪点新火，火会记得前一夜。"],pace:"light",
...
place:"契约纸 · 仪式之约",
text:["缚魂者的传承里有一句老话：“约，要写在能烧的纸上。烧了，才算数。”", "城西文书铺的契约纸，是羊皮做的，边角压着火漆。文书匠说，那纸经得起改写。", "你需要的，是一张空白的、还没被写过的契约纸。"],pace:"light",
...
place:"银液 · 仪式之约",
text:["你坩埚里那瓶用不完的银液，其实不是你的——炼金同业会的人说，那是“初液”，每一炉都从它分出来。", "真正的银液，只认蒸馏台。谁在台上守满三炉，它才认谁。", "你自己的那瓶，就是。"],pace:"light",
...
place:"精铁块 · 仪式之约",
text:["老铁匠看了一眼你的铁环：“火认了你，铁还没认。”", "“铁认人，靠的是精铁——千锤百炼、没夹过渣的。公会铁匠铺里有，修好霍根的锻锤，他会给你一块。”", "精铁块是铁的骨头。用它做引，铁才会听你的话。"],pace:"light",
...
place:"黄铜齿轮 · 仪式之约",
text:["机械鸟啄了啄你的图纸，又啄了啄桌角——那有个凹痕，正好是齿轮的形状。", "你懂了：它要一枚齿轮。东境工坊的废料箱里，这样的齿轮多得是。", "旧的齿轮最好，齿缝里嵌着上一个造物主的黑油。"],pace:"light",
...
place:"兽血 · 仪式之约",
text:["你掌心的暗红色线，这几天又深了一点。你问医师，他摇头：“这不是病。”", "猎场的老猎户说，血脉的事，要用兽血应——不是杀生，是取一头自愿的兽的血。", "猎场屠宰棚里，每天都有猎户分好的小皮囊。"],pace:"light",
...
place:"狂兽之牙 · 仪式之约",
text:["教官听说你想走狂战士的路，沉默了一会儿：“怒意是兽。驯兽，要先有兽的东西。”", "“狂兽之牙——草原上发狂的兽，牙根带着血。拿它当引，你的怒意才知道谁说了算。”", "猎场深处，偶尔能捡到这样的牙。"],pace:"light",
...
place:"旧剑刃 · 仪式之约",
text:["武库看守说，你摸剑的手感是天生的，但还差一味：“旧剑刃。”", "“断过的剑，刃口还留着一点寒光。那点寒光里，是前一任剑主的握法。”", "武库报废架上，这样的断剑有一堆。"],pace:"light",
...
place:"铁钉 · 仪式之约",
text:["箭楼哨兵听你说要学盾阵，点点头：“盾不是铁打的，是钉子钉的。”", "“一块盾要经得住，全靠每颗钉子都咬住木头。找一枚旧铁钉——弯过又直回来的那种。”", "铁匠铺的废渣堆里，这样的钉子多得是。"],pace:"light",
...
place:"旧军旗 · 仪式之约",
text:["军略课教官带你去军需库，指着一面旧旗：“为将者，先学会认旗。”", "“旧旗上烧过的洞，是它替你挡过的祸。拿一截旧旗做引，你的阵，才记得自己是谁的阵。”", "军需库的旧物资里，收着历年换下来的旗。"],pace:"light",
...
place:"圣城长明灯芯 · 仪式之约",
text:["老修士教你的不是祷告，是灯：“圣辉不灭，是因为有人添油。”", "“圣城长明灯烧了三百年的灯芯，是圣辉的根。你要立誓，先借一段根。”", "圣城教堂的圣坛，长明灯从不断。灯芯每年换一次，换下来的都收在圣物柜。"],pace:"light",
...
place:"圣水 · 仪式之约",
text:["侧廊的老妇教会你一件事：护着别人，自己先要立得住。", "立得住的法子，在圣水里——清晨弥撒前取一小瓶，沾在额上，心里那面盾才不会锈。", "教堂圣坛的铜瓶里，盛着隔夜的圣水。"],pace:"light",
...
place:"驿道图 · 仪式之约",
text:["驿丞听说你要走四方，从旧图柜里抽出一张图：“巡游的人，先认路。”", "“这张图是废的——上面的路标，三年没更新了。可它记着所有走错过的路。”", "走错过的路，比走对的路，更值得记。"],pace:"light",
...
place:"黑曜石刀片 · 仪式之约",
text:["地牢深处的歌声，你又听见了一次。这次，你听清了一句：“黑曜石认得夜里的人。”", "黑曜石刀片，沙漠深处的石头打磨成的。锋利得能划开月光，也划得开旧誓。", "废矿的尽头，有人埋过一片。"],pace:"light",
...
place:"兽皮 · 仪式之约",
text:["猎场看守听你说要学追猎，指指墙上的兽皮：“猎人的手，先认皮。”", "“兽皮是兽的一生。硝过的硬皮，摸得出它跑过哪些地方。”", "猎场晒皮架上，晾着新硝的兽皮。"],pace:"light",
...
place:"精灵林间晶露 · 仪式之约",
text:["巡林者前辈教你看树：“树不说谎。你要守一片林，先喝一口林的记忆。”", "精灵林间的晶露，是精灵收集百年的晨露。喝下它，能看见森林的记忆。", "银叶城边缘的杉树林，黎明前最浓。"],pace:"light",
...
place:"兽骨 · 仪式之约",
text:["灰猫带你去溪谷，蹲在一节兽骨前，不走。", "你懂了：兽语者要学兽的言语，先有一件兽的东西。", "溪谷里的兽骨，被水冲得光洁，风一吹会响——那是兽留给风的语言。"],pace:"light",
...
place:"夜枭羽 · 仪式之约",
text:["你练“不在”练到第三夜，窗台上落了一根漆黑的羽毛。", "不是鸟掉的——是夜枭自己拔下来，放在那里的。夜枭是夜里的猎手，它认得同类。", "钟楼顶的夜枭，每夜都在那里。它偶尔会留下这样的信物。"],pace:"light",
...
place:"旧铜锁 · 仪式之约",
text:["你回味着铜盒那七个齿的松紧，手痒得厉害。", "城西杂货摊的摊主说：“锁匠的手，是旧锁喂出来的。找一把钥匙丢了的旧锁，慢慢听。”", "旧货摊上，这样的铜锁摆了一排。"],pace:"light",
...
place:"暗蚀会文书 · 仪式之约",
text:["你顺着那条线，摸到了一点暗蚀会的东西。", "档案室主任的账册、城南铁匠铺的纸条——这些线索的源头，都指向一种文书。", "暗蚀会文书，字迹工整，落款只有一个倒悬的钟。地下世界里，这东西能换一条命。"],pace:"light",
...
place:"无面蜡 · 仪式之约",
text:["你看着镜子里自己的脸，忽然想：这张脸，是不是也可以不是你的？", "面具匠说，无面蜡能塑成任何形状，就是捏不成一张脸——因为捏蜡的手，就是脸的主人。", "澡堂更衣间的梳妆台角落，刮着这样的蜡。"],pace:"light",
...
place:"药草 · 仪式之约",
text:["医师教你认药：“药不是治伤的，是让伤自己的人，愿意好起来。”", "后山向阳坡上的药草，叶背泛白，揉碎了有股醒脑的苦。", "用它当引，你的手才知道，该把那股凉意往哪里送。"],pace:"light",
...
place:"净化令文书 · 仪式之约",
text:["告解室那件事之后，你开始查教会里的旧文书。", "净化令文书——盖着圣痕司火漆的教令，措辞庄严，字里行间却透着焦味。", "教会档案室的旧卷柜里，压着历年收回的净化令。"],pace:"light",
...
place:"圣徽 · 仪式之约",
text:["靶场女孩问你的那个问题——“你教我的，算不算神术？”——你一直没有答案。", "圣徽是答案的一半：一枚磨得发亮的铜徽，正面刻着太阳。", "教会圣物柜里收着历年替换下来的旧圣徽。"],pace:"light",
...
place:"苦修石 · 仪式之约",
text:["老修士说，那块石头他跪了九年。你问他为什么，他答：“因为它不回答。”", "苦修者需要的，是一块不回答的石头——河滩上拣一块顺手的，够沉，够冷。", "不用找特别的。哪块石头都不回答。"],pace:"light",
...
place:"银月商会券 · 仪式之约",
text:["老板娘教你的第一课，是看。你看懂了陶碗的章，但她还有一课没教：", "“看懂了东西，还要看得懂纸。银月商会的券，一张纸，撬得动整条商路。”", "南方城邦的银月商会，发的券在商人手里比金币还硬。"],pace:"light",
...
place:"禁运货单 · 仪式之约",
text:["船夫老头看过你带来的木箱，什么也没问，只推过一张油渍斑斑的货单。", "“货名被划了三道，底下写着另一种货名——这就是走暗线的规矩。”", "码头旧货舱的箱底，压着历年换下来的货单。"],pace:"light",
...
N["arrive_generic"] = {tag:"main",
  place:"未知之地", text:["风尘仆仆。你踏上了这片土地。","远处有炊烟，近处有狗吠。世界照常运转，并不为你的到来多停一秒。"],pace:"light",
  options:[
...
N["act_rest"] = {
  place:"落脚处", text:["你找了个便宜的客栈。跳蚤在褥子里蹦跳，隔壁传来鼾声与梦话。","睡一觉。明日的事，明日再说。"],pace:"light",
  options:[
