...
N["acad_event_y1"]={tag:"event",place:"艾尔达魔法学院 · 秋",pace:"light",text:[
"秋雨连下三天，学院的排水渠堵了。全宿舍的人都被叫去疏通。",
"你穿着旧斗篷站在泥水里，和凯恩、洛卡接力往外掏烂树叶。艾莉丝在边上喊加油，被凯恩泼了一身泥。",
"闹了一下午，渠通了。学院管事赏了每人一碗姜汤。",
"你捧着热汤，看着满院湿漉漉的灯火——这种日子，不算惊天动地，但让人踏实。"
],options:[
{t:"喝完姜汤，回宿舍",effects:{xp:8},tier:{ok:["姜汤驱了寒。你抖抖斗篷上的泥，回宿舍睡了。"]},go:"acad_life_y1_dorm"}
]};
N["acad_event_y2"]={tag:"event",place:"艾尔达魔法学院 · 冬",pace:"light",text:[
"冬夜，学院组织了一场“守夜人体验”——每人值一个时辰夜班。",
"你提着风灯，沿着东回廊走。雪很大，灯笼的光只能照出三步远。",
"走到图书馆拐角时，你听见塔顶传来一声轻响——像什么东西，轻轻碰了一下钟。",
"你抬头。塔顶的灯，亮着。"
],options:[
