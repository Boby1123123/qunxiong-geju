...
{id:"led_war_02", type:"设定", desc:"守钟人铁牌与七锚重走（战后收束）", plant:"war_after_4", reap:"war_epilogue_16", status:"open", world:"vol_north"},
  {id:"led_echo_01", type:"伏笔", desc:"放过劫匪的回响——矮人王都卖炭翁磕头报恩（CON-2 回响节点）", plant:"flag:spared_robber", reap:"node:echo_spared_robber", status:"open", world:"回响线"},  {id:"led_echo_02", type:"伏笔", desc:"助过巨人的回响——铁砧议会厅外铁匠提起山岭巨人（CON-2 回响节点）", plant:"flag:giant_helper", reap:"node:echo_giant_helper", status:"open", world:"回响线"},  {id:"led_echo_03", type:"伏笔", desc:"金秤黑名单的回响——银穗河码头老账房修秤摊（CON-2 回响节点）", plant:"flag:gold_scale_blacklisted", reap:"node:echo_gold_scale_blacklisted", status:"open", world:"回响线"},  {id:"led_echo_04", type:"伏笔", desc:"东境通缉的回响——承天街市画像不像、馄饨摊多搁虾皮（CON-2 回响节点）", plant:"flag:east_wanted", reap:"node:echo_east_wanted", status:"open", world:"回响线"},  {id:"led_echo_05", type:"伏笔", desc:"背叛同窗的回响——精灵长老会案卷与誊书精灵（CON-2 回响节点）", plant:"flag:betrayed_classmate", reap:"node:echo_betrayed_classmate", status:"open", world:"回响线"},  {id:"led_echo_06", type:"伏笔", desc:"解放女王艾萨拉的回响——银月祭坛三枚银币（CON-2 回响节点）", plant:"flag:seal3_queen_freed", reap:"node:echo_seal3_queen_freed", status:"open", world:"回响线"},  {id:"led_echo_07", type:"伏笔", desc:"墨丘利盟友的回响——交汇城钟楼弹银币（CON-2 回响节点）", plant:"flag:mercury_ally", reap:"node:echo_mercury_ally", status:"open", world:"回响线"},  {id:"led_echo_08", type:"伏笔", desc:"令墨丘利失望的回响——药剂铺空瓶与字条（CON-2 回响节点）", plant:"flag:mercury_disappointed", reap:"node:echo_mercury_disappointed", status:"open", world:"回响线"},  {id:"led_echo_09", type:"伏笔", desc:"盗贼公会成员的回响——贫民窟补鞋哑巴的墙根记号（CON-2 回响节点）", plant:"flag:thieves_guild_member", reap:"node:echo_thieves_guild_member", status:"open", world:"回响线"},  {id:"led_echo_10", type:"伏笔", desc:"守夜人邀请的回响——深夜归城铜哨未响（CON-2 回响节点）", plant:"flag:watchmen_invited", reap:"node:echo_watchmen_invited", status:"open", world:"回响线"},  {id:"led_echo_11", type:"伏笔", desc:"浮空塔祝福的回响——半截塔基灰鸽与袖口烫意（CON-2 回响节点）", plant:"flag:floating_tower_blessed", reap:"node:echo_floating_tower_blessed", status:"open", world:"回响线"},  {id:"led_echo_12", type:"伏笔", desc:"放逐浮空塔的回响——塔基刻字『塔走了地还在』（CON-2 回响节点）", plant:"flag:floating_tower_banished", reap:"node:echo_floating_tower_banished", status:"open", world:"回响线"},  {id:"led_echo_13", type:"伏笔", desc:"塞拉芬替身承诺的回响——学院山门扫雪杂役（CON-2 回响节点）", plant:"flag:seraphine_substitute_promise", reap:"node:echo_seraphine_substitute_promise", status:"open", world:"回响线"},  {id:"led_echo_14", type:"伏笔", desc:"绕行学院的回响——多年后重踏学院山门（CON-2 回响节点）", plant:"flag:skip_academy", reap:"node:echo_skip_academy", status:"open", world:"回响线"},  {id:"led_echo_15", type:"伏笔", desc:"大汗知情的回响——图腾林边牧人孩子与老牧人奶干（CON-2 回响节点）", plant:"flag:khan_aware", reap:"node:echo_khan_aware", status:"open", world:"回响线"},  {id:"led_echo_16", type:"伏笔", desc:"违抗预言的回响——猎人小道石头上炭画白狼（CON-2 回响节点）", plant:"flag:prophecy_defied", reap:"node:echo_prophecy_defied", status:"open", world:"回响线"},  {id:"led_echo_17", type:"伏笔", desc:"揭穿假神谕的回响——兽人集市孩子与老萨满的盐（CON-2 回响节点）", plant:"flag:oracle_fake", reap:"node:echo_oracle_fake", status:"open", world:"回响线"},  {id:"led_echo_18", type:"伏笔", desc:"放走信使的回响——驿站驿卒转述怪人带话（CON-2 回响节点）", plant:"flag:let_mercury_go", reap:"node:echo_let_mercury_go", status:"open", world:"回响线"},  {id:"led_echo_19", type:"伏笔", desc:"支持净化令的回响——铁门关茶摊议论与抱孩子妇人（CON-2 回响节点）", plant:"flag:council_support_purification", reap:"node:echo_council_support_purification", status:"open", world:"回响线"},  {id:"led_echo_20", type:"伏笔", desc:"反对净化令的回响——脚夫顺口溜与卖饼老头的酱（CON-2 回响节点）", plant:"flag:council_oppose_purification", reap:"node:echo_council_oppose_purification", status:"open", world:"回响线"},  {id:"led_echo_21", type:"伏笔", desc:"折中净化令的回响——布摊老板谢那句『先查账后抓人』（CON-2 回响节点）", plant:"flag:council_compromise_purification", reap:"node:echo_council_compromise_purification", status:"open", world:"回响线"},  {id:"led_echo_22", type:"伏笔", desc:"幼龙同行的回响——铁门关守城老卒想摸又不敢（CON-2 回响节点）", plant:"flag:dragon_companion", reap:"node:echo_dragon_companion", status:"open", world:"回响线"},  {id:"led_echo_23", type:"伏笔", desc:"净化令加剧的回响——宵禁提前、客栈窗纸糊三层（CON-2 回响节点）", plant:"flag:purge_intensified", reap:"node:echo_purge_intensified", status:"open", world:"回响线"},  {id:"led_echo_24", type:"伏笔", desc:"解放水岸的回响——东军老兵阵前军礼（CON-2 回响节点）", plant:"flag:aquan_liberated", reap:"node:echo_aquan_liberated", status:"open", world:"回响线"},  {id:"led_echo_25", type:"伏笔", desc:"北境送粮的回响——传令兵私下道谢（CON-2 回响节点）", plant:"flag:beijing_saved", reap:"node:echo_beijing_saved", status:"open", world:"回响线"},  {id:"led_echo_26", type:"伏笔", desc:"散尽家财的回响——难民营瘸腿老妇塞炒面（CON-2 回响节点）", plant:"flag:gave_all_to_refugees", reap:"node:echo_gave_all_to_refugees", status:"open", world:"回响线"},  {id:"led_echo_27", type:"伏笔", desc:"勒索美第奇的传闻——粥棚老人说拿把柄的人少（CON-2 回响节点）", plant:"flag:medici_blackmailed", reap:"node:echo_medici_blackmailed", status:"open", world:"回响线"},  {id:"led_echo_28", type:"伏笔", desc:"手刃匪首的回响——北坡老卒塞干饼、官道木牌（CON-2 回响节点）", plant:"flag:bandit_leader_killed", reap:"node:echo_bandit_leader_killed", status:"open", world:"回响线"},  {id:"led_echo_29", type:"伏笔", desc:"暗蚀渗透的回响——烽火台下埋过的鸦羽铜牌（CON-2 回响节点）", plant:"flag:eclipse_infiltrator", reap:"node:echo_eclipse_infiltrator", status:"open", world:"回响线"},  {id:"led_echo_30", type:"伏笔", desc:"拒绝父亲真相的回响——烽火台北风与未拆的信（CON-2 回响节点）", plant:"flag:father_truth_denied", reap:"node:echo_father_truth_denied", status:"open", world:"回响线"}
