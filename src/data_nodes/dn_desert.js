...
N["desert_lvzhou_market"] = {
  ...
  text:[
    ...
    "「井见底了，水价涨了三倍。」他抱起一罐水，晃了晃，「要我说，涨价还是小事。真正麻烦的是——」他压着嗓门，「有人开始『卖』井的消息了。谁先知道水从哪来，谁就发财。」", "绿洲集市城的动静在身后淡了。你把行囊带子紧了紧，继续上路。"],
  options:[
...
N["desert_caravan3"] = {
  ...
  text:[
    ...
    "「封印的根在喘气。」白驼声音发紧，「这口气要是吹到绿洲，那口井就真的没了。」他转向你，「驼队要掉头，我护货。你要是想追那条线索——」他指指雾气深处，「夜车的路，就在那边。」", "北线在雾里模糊了轮廓。你紧了紧衣领，迈步上路。"],
  options:[
