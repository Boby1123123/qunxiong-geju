...
N["elf_deep_mist"] = {
  ...
  text:[
    ...
    "一个声音从门内飘出来：「要么进来，要么走。在雾边站久了，雾会记住你。」", "迷雾边界在雾里模糊了轮廓。你紧了紧衣领，迈步上路。"],pace:"normal",
  options:[
...
N["elf_deep_grove"] = {
  ...
  text:[
    ...
    "小兽忽然竖起耳朵，朝树林深处叫了一声——那声音清亮得像铃铛。", "世界树外围的动静在身后淡了。你把行囊带子紧了紧，继续上路。"],pace:"normal",
  options:[
...
N["dwarf_deep_bard"] = {
  ...
  text:[
    ...
    "他面前的案台上，摆着一排长短不一的成品刀剑，刃口都磨得可以照人。", "你与王都作别，踏上旅途。尘土扑上靴面，像旧识。"],pace:"normal",
  options:[
...
N["dwarf_deep_mine2"] = {
  ...
  text:[
    ...
    "远处，矿道深处传来一声极轻的、缓慢的声响——像是石头在很深的地方，翻了个身。", "别过王都，你沿官道走出里许，回头已看不清来处。"],pace:"normal",
  options:[
