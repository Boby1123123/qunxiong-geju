...
/* ================= 势力一：自由城商会 ================= */
N["faction_free_1"]={tag:"main",place:"自由城邦 · 商会大堂",where:"白昼",pace:"normal",sceneTitle:"阵营 · 自由城商会",text:[
...
"窗外，码头上的船帆在风里扯得笔直。战乱里的钱，只有攥在自己人手里才踏实——这是商会的第一条规矩。"
],options:[
...
N["faction_free_2"]={tag:"main",place:"自由城邦 · 北门",where:"白昼",pace:"normal",text:[
...
N["faction_free_3"]={tag:"main",place:"自由城邦 · 商会大堂",where:"白昼",pace:"normal",text:[
...
N["faction_free_4"]={tag:"main",place:"自由城邦 · 商会大堂",where:"夜",pace:"deep",sceneTitle:"抉择 · 商会的立场",text:[
...
"李管事把核桃往桌上一拍，看向你：“你管着北门货栈，你说，这碗水怎么端？”"
],options:[
...
N["faction_free_5"]={tag:"main",place:"北境 · 雪原 · 盐道",where:"白昼",pace:"deep",text:[
...
"你带着商会的帖子上了路。铁门关的守将是个刀削脸的中年人，听完你的来意，只说了一句：“盐可以放，拿东西换——军饷缺三个月了。”"
],options:[
...
N["faction_free_6"]={tag:"main",place:"自由城邦 · 北门货栈",where:"夜",pace:"normal",sceneTitle:"考验 · 货栈的暗门",text:[
"盐路通了，你的货栈也跟着红火起来。",
"红火的第二个月，来了个生面孔。他穿得像个行商，可手上的茧子不像握算盘的。他关上房门，压低声音：“北边有一批货，想从你的栈里过一道。价钱好说。”",
"他摊开手掌，掌心里躺着一枚军械营的标记。",
"你盯着那枚标记。这活儿接下来，钱是白花花的；可要是东窗事发，商会百年招牌，连带你这条命，都得搭进去。"
],options:[
...
N["faction_free_7"]={tag:"main",place:"自由城邦 · 商会大堂",where:"白昼",pace:"normal",text:[
...
N["faction_free_8"]={tag:"main",place:"自由城邦 · 商会大堂",where:"夜",pace:"deep",sceneTitle:"抉择 · 商会的忠诚",text:[
...
N["faction_free_9"]={tag:"main",place:"自由城邦 · 商会大堂",where:"白昼",pace:"normal",sceneTitle:"坐镇 · 自由城的生意",text:[
"终战的硝烟散尽后，自由城的商会重新开张。",
"你坐在大堂的主位上，手里转着两个核桃——那是李管事留给你的。货栈的账、盐道的契、驮队的路引，一摞一摞摆在案上。",
"有人问，商会在战乱里挣了多少。你只笑了笑。账本上那些数字是死的，可活下来的铺子、跑通的路、稳住的人心，才是商会真正挣下的东西。",
"窗外，码头的船又扬了帆。自由城还是那个自由城，只是你坐的位置，不一样了。"
],options:[
{t:"（坐镇自由城，把商会的路继续走下去）",effects:{xp:25,flag:"faction_free_done"},go:"warphase_14"}
]};

/* ================= 势力二：北境联军 ================= */
N["faction_north_1"]={tag:"main",place:"北境 · 第三哨 · 校场",where:"白昼",pace:"normal",sceneTitle:"阵营 · 北境联军",text:[
...
N["faction_north_2"]={tag:"main",place:"北境 · 第三哨 · 城头",where:"夜",pace:"deep",text:[
"入伍第三天，你就上了城头值夜。",
...
N["faction_north_3"]={tag:"main",place:"北境 · 雪原 · 敌营外",where:"夜",pace:"deep",text:[
"你摸过河的那一夜，雪下得正紧。",
...
N["faction_north_4"]={tag:"main",place:"北境 · 第三哨 · 军务厅",where:"白昼",pace:"deep",sceneTitle:"抉择 · 联军的打法",text:[
...
"你盯着地图上那条冻河。怎么打，不只是打法的问题——这一仗怎么打，联军的血就往哪儿流。"
],options:[
...
N["faction_north_5"]={tag:"main",place:"北境 · 第三哨 · 城头",where:"夜",pace:"deep",text:[
...
N["faction_north_7"]={tag:"main",place:"北境 · 联军大营",where:"夜",pace:"normal",text:[
...
N["faction_north_8"]={tag:"main",place:"北境 · 联军大营",where:"夜",pace:"deep",sceneTitle:"抉择 · 军人的路",text:[
...
"帐外，士兵们围在火堆旁，小声唱着家乡的调子。你听着那歌声，把手按在图上。"
],options:[
...
N["faction_north_9"]={tag:"main",place:"北境 · 第三哨 · 城头",where:"白昼",pace:"normal",sceneTitle:"坐镇 · 北境之旗",text:[
"终战之后，都尉把联军的帅旗交到你手里：“我老了，打不动了。北境这副担子，你挑。”",
"你站在第三哨的城头上，手里的帅旗在风里展开。雪原上，联军的大营正在拔营——仗打完了，兵要回乡。",
"你看着那面旗，想起冻河滩的夜、围城的雪、终战的号角，想起那些念了名字的人。",
"北境从此有了新的旗手。你知道，这面旗不是立给谁看的——它是立给雪原上每一个活下来的人的。"
],options:[
{t:"（接过帅旗，镇守北境）",effects:{xp:25,flag:"faction_north_done"},go:"warphase_14"}
]};
/* ================= 势力三：光明教会 ================= */
N["faction_church_1"]={tag:"main",place:"圣城 · 大教堂 · 回廊",where:"白昼",pace:"normal",sceneTitle:"阵营 · 光明教会",text:[
"战争打起来以后，圣城的教堂反而比平时更挤。",
"逃难的人把教堂的条凳坐满，教士们端着粥桶在人群中穿梭。你帮忙抬了两天伤员，一个穿灰袍的老执事拦住了你：“你的手很稳。留下来，教会需要这样的人。”",
"他领你走进大教堂的回廊，壁画上的圣光洒下来，落在地上像一层水。老执事回头看了你一眼：“教会不问出身，只问心。你可愿侍奉光明？”"
],options:[
...
N["faction_church_2"]={tag:"main",place:"圣城 · 教会医院",where:"夜",pace:"deep",text:[
"你在教会医院帮了半个月忙。",
...
N["faction_church_4"]={tag:"main",place:"圣城 · 大教堂",where:"夜",pace:"deep",sceneTitle:"抉择 · 教会的刀",text:[
...
N["faction_church_7"]={tag:"main",place:"圣城 · 圣痕司",where:"夜",pace:"normal",text:[
"艾琳的案子，最后以“查无实据”结了。",
"是你压下去的。你把卷宗里那几页“证据”翻来覆去看了三遍，每一遍都看出同一个漏洞：证词是抄的，笔迹对不上。",
"老执事什么都没问。他只在你的名字后面，用炭笔划了一道。",
"你知道那道划痕的意思：教会记住了你。可你更清楚，自己记住的是什么——那卷宗里的漏洞，是有人故意留的。"
],options:[
{t:"（在圣痕司站稳，守住心里那把秤）",effects:{xp:24,infl:{church:10},flag:"faction_church_stand"},go:"faction_church_8"}
]};

N["faction_church_8"]={tag:"main",place:"圣城 · 大教堂 · 圣坛前",where:"夜",pace:"deep",sceneTitle:"抉择 · 光明与权力",text:[
...
N["faction_church_9"]={tag:"main",place:"圣城 · 大教堂 · 钟楼",where:"白昼",pace:"normal",sceneTitle:"坐镇 · 圣城的钟声",text:[
...
N["faction_desert_2"]={tag:"main",place:"死亡沙漠 · 驼道",where:"白昼",pace:"deep",text:[
"入部第一趟差事，是押一支驼队穿过风暴眼。",
...
N["faction_desert_3"]={tag:"main",place:"死亡沙漠 · 诸部大帐",where:"夜",pace:"deep",text:[
"诸部的大帐，是沙漠里最热闹也最凶险的地方。",
"五个部族的头领围坐在火堆旁，为一件小事吵得面红耳赤：一块水草地的归属。有人拍案，有人拔刀，火堆被搅得火星四溅。",
"扎克把你推到人前：“这是走过风暴的兄弟，让他说两句。”",
"几双眼睛一齐看过来，像几把刀。你知道，这一句话说得不好，自己在沙漠里的路就断了。"
],options:[
...
N["faction_desert_4"]={tag:"main",place:"死亡沙漠 · 绿洲集市城",where:"白昼",pace:"normal",sceneTitle:"抉择 · 诸部的刀口",text:[
"水草地的事解决后，诸部把你当成了自己人。扎克喝多了茶，跟你说了一桩心事。",
"“北边打仗，要粮。南边运粮，要过沙漠。有人找上诸部，说只要放粮队过去，给三成利。”他放下茶碗，“可也有人说，扣下粮队，能跟北边换更好的价。”",
"他盯着你：“这买卖，你说做不做。”",
"茶碗里的水汽袅袅地往上飘。你知道，这一句话，决定诸部站哪一边。"
],options:[
...
N["faction_desert_7"]={tag:"main",place:"死亡沙漠 · 诸部大帐",where:"夜",pace:"normal",text:[
...
N["faction_desert_8"]={tag:"main",place:"死亡沙漠 · 诸部大帐",where:"夜",pace:"deep",sceneTitle:"抉择 · 沙海的船",text:[
"终战结束的消息传到沙漠，比水还慢。",
"诸部的大帐里，头领们为战后的路吵了三天三夜：有人要跟北边结盟，有人要跟教会结盟，有人要谁都不靠，关起门来过日子。",
"扎克病倒了，躺在帐里，把一枚驼铃塞进你手里：“诸部的路，你替我走。往哪走，你说了算。”",
"驼铃在你手心里，沉甸甸的。帐外，沙漠的风呜呜地响，像无数个声音在问同一个问题。"
],options:[
...
N["faction_desert_9"]={tag:"main",place:"死亡沙漠 · 绿洲集市城 · 望沙台",where:"白昼",pace:"normal",sceneTitle:"坐镇 · 沙漠的路",text:[
"你站在望沙台上，看太阳从沙海尽头升起来。",
...
/* ================= 背叛惩罚支线（阵营通用） ================= */
N["faction_traitor_1"]={tag:"main",place:"大陆 · 亡命路上",where:"夜",pace:"deep",sceneTitle:"背叛 · 亡命",text:[
"你递出去的那份东西，第三天就东窗事发了。",
...
N["faction_traitor_2"]={tag:"main",place:"大陆 · 边境 · 无名渡口",where:"夜",pace:"deep",text:[
"你逃到边境的无名渡口，只剩最后一枚银币。",
"渡口的艄公认出你腰间那块军牌：“你从北边来？北边的人，现在都欠着三条命。”他掂了掂银币，没有收，“上船吧。到了对岸，别再提你从前的事。”",
"船到江心，艄公忽然开口：“我年轻时也背过一回名声。背上它，就再也卸不下来了。”",
"你看着对岸的灯火，江水在船底哗哗地响。你忽然明白，背叛这回事，逃得再远，也逃不出自己心里那杆秤。"
],options:[
...
N["faction_traitor_3"]={tag:"main",place:"原阵营 · 议事堂外",where:"白昼",pace:"deep",sceneTitle:"了结 · 回去还账",text:[
"你回去了。",
"议事堂外，守卫拦住了你。你没有硬闯，把带来的东西放在地上，退后三步：“东西在这儿。要杀要剐，给个痛快。”",
"堂门开了。老执事——或者都尉、李管事、扎克，看你的人——走出来，看着地上的东西，看了很久。",
"他最终没有让人动手。“东西还回来，账就清一半。”他抬头看你，“剩下的一半，你拿命去还，还是拿日子去还？”"
],options:[
...
N["faction_traitor_4"]={tag:"main",place:"大陆 · 各处",where:"白昼",pace:"normal",sceneTitle:"流亡 · 名声的代价",text:[
"背叛的代价，你一分一分地尝完了。",
"名字没了，声望没了，从前那些笑脸也没了。你走在路上，有人认得你，远远地啐一口。",
"可你还活着。夜里躺在野地里看星星的时候，你想明白了一件事：名声是别人给的，日子是自己过的。只要心里那杆秤还在，就还能从头再来。",
"你把腰间那块旧军牌解下来，扔进河里。水花溅起又落下，牌子沉了底。你站起来，拍了拍身上的土，朝前走去。"
],options:[
