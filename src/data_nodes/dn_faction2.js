...
"交卷的时候，主考的学士多看了你一眼。那一眼很淡，但你读得懂——承天城里，能写出这句话的人不多。"
],options:[
...
"你合上账册。窗外的天阴着，像要下雪——承天城的天，从来都是这么阴着的。"
],options:[
...
"你把档册合上，塞回原处。承天城把晨天故都从册子上抹掉了，可抹不掉的是那些还在找它的人。"
],options:[
...
"堂上安静下来。仓吏的额头贴在地上，抖得像风里的叶子。你知道，这一断，断的不只是一个人的前程。"
],options:[
...
"你看着庙里的烛火，想起档房里那页写着“弃”字的旧档。有些事，承天城抹掉了，可还有人替它记着。"
],options:[
...
"他看见你走进来，上下打量：“你在雪原上跟狼群照过面？敢来的，都是不怕死的。”他拍了拍身边的皮褥子，“坐。草原的规矩，坐下就是兄弟。”"
],options:[
...
"阿岩也盯着那片灰影，声音沉了沉：“我们诸部，得在狼群之前，先想好往哪走。”"
],options:[
...
"夜风里，火堆的光在他脸上跳。这个年轻猎手，第一次把诸部的路，压到了你肩上。"
],options:[
...
"你看着那些粗犷的面孔，忽然明白——草原人不是不怕死，是他们把死看得太轻，把兄弟看得太重。"
],options:[
...
"他敲了敲手里的锤子：“山里的规矩简单——能扛动锤子的，就是兄弟。”他把一柄铁锤扔到你面前，“试试？”"
],options:[
...
"几道目光齐刷刷看过来。你站在厅中央，闻着满屋的炉灰味和酒味，知道这一句话，可能决定山国三百年的门，开还是不开。"
],options:[
...
"炉火映着他花白的胡子。你知道，这柄锤子递过来的，不止是一份差事。"
],options:[
...
"你转身看着山门外灰蒙蒙的天。铁已经淬好了，接下来，是它见血的时候。"
],options:[
...
"他看着你：“战争来了。林邦不想打仗，可林邦也不怕打仗。你说，树该怎么做？”"
],options:[
...
"巡林长让你坐到长老席边上——林邦少有的例外。他放轻声音：“他们信树，也信一个见过外面的人。”"
],options:[
...
"巡林长站在你身边，声音放轻：“林邦守了世界树三百年。可这一次，怕是守不住了——除非，有人能把它重新镇住。”"
],options:[
...
"你扶着树干，感受着粗粝的树皮底下，那股沉沉的、持续的搏动。像心跳。"
],options:[
...
"你把手掌贴在泪石上，凉意透进掌心。你想起老萨满的兽骨、矮人矿洞的铁门、深渊的封印。这片大陆的锁，还没有全部锁上。"
],options:[
