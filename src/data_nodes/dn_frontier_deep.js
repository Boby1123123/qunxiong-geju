...
(function () {
  ...
  N["frontier_mine_1"] = {
    ...
    ,"矿洞口的风带着一股潮气，往骨头缝里钻。木栅栏上的牌子字迹模糊，像是写了很多年，被雪水泡过几回。老钱蹲着的地方，地上一圈剥下来的豆壳，已经被冻得发脆。","他数豆子的时候，你注意到他那只瘸腿，脚踝处凹下去一块，像是旧伤。他见你盯着，自己倒先说了一句：“二十年前封洞，我就在底下。命是捡回来的，腿留给了矿。”他说完又剥了一颗豆子，不再看你。"],
    options: [
  ...
  N["frontier_mine_2"] = {
    ...
    ,"巷道里那股潮气越来越重，火把的焰苗压得低低的，光晕外全是浓黑的影子。你拿火把往壁上一照，看见几道旧刻痕——像是指甲抓的，从膝盖高的地方一直拖到头顶，深深浅浅，断在矿脉凹槽的边缘。","你数着步子往里走，脚下不时踢到碎石。某一处，你踩到一块松动的石板，底下发出空空的回响——像是底下还有一层，被石板盖住了。你蹲下去敲了敲，声音闷而实，听不出深浅。"],
    options: [
  ...
  N["frontier_mine_3"] = {
    ...
    ,"那半张羊皮纸摸上去发脆，边角烧卷了，你怕它碎，没敢折，只平摊着看。红炭标的那个叉，笔画很重，像是刘三画的时候下了狠劲——他把命押在这个叉上。","账本末页那道指甲刮痕很深，几乎划破纸背。你把账本合上，又掂了掂那盏砸扁的矿灯——灯身凹下去的地方，沾着一层干涸的暗色，说不清是锈还是别的。你把这堆东西一样样收好，揣进怀里。"],
    options: [
  ...
  N["frontier_mine_6"] = {
    ...
    ,"那些骨头码得整整齐齐，头骨都朝着同一个方向，你盯着看了一阵，心里发毛——它们不像被水流冲成这样的，倒像是被谁摆好的。有的骨头上还缠着烂布条，布料的花纹已经看不出原样。","裂缝里的风一阵一阵的，带着潮腥气。你伸手进去的时候，指尖先碰到冰凉的铁——那牌子的边缘很钝，不像新铸的，倒像在石缝里嵌了几十年。你抠了两下，牌子松了，掉进你手心。"],
    options: [
  ...
  N["frontier_mine_8b"] = {
    ...
    ,"老钱说封洞那晚的事时，声音压得低，像是怕洞里的东西听见。他说到空棺材的时候，手指在碗沿上反复摩挲，指节发白。","他说完最后一句话，把碗扣在膝盖上，很久没动。风从洞口灌进来，他缩了缩脖子，像是觉得冷。你谢过他，走出栅栏时，听见他在身后又说了一句：“牌子的事，烂在肚子里。”"],
    options: [
  ...
  N["frontier_tie_1c"] = {
    ...
    ,"那张纸上的字虽然丑，可画得仔细。你把三个点又看了一遍，圈、叉、三角，旁边的小字写得很用力，纸都透出印子。老铁摸清地方不是一天两天了。","你把纸折好收进怀里的时候，窗外的风又紧了一阵。雪粒扑在窗纸上，簌簌地响。你起身时，营房里的老兵都看着你——没有人说话，但那些眼神都明白：你要是去找老铁，他们就当没看见你出城。"],
    options: [
  ...
  N["frontier_tie_4"] = {
    ...
    ,"你蹲在雪梁后，风把雪沫子扬起来，灌进领口，凉得刺骨。你数着驼背巡夜的步子，一步，两步，铁钎拄在冰面上，声音在风里传出很远。等他走远，你才贴着冰壁滑下去。","拐角后面那说话声，尖嗓子那个，声音又细又尖，像指甲刮玻璃。他说到“一并处理”的时候，语气平淡，像是在说一件顺手的小事。你贴在冰壁上，等心跳稳下来，才继续往前摸。"],
    options: [
  ...
  N["frontier_tie_5"] = {
    ...
    ,"冰屋里的寒气重，你掀开皮子一角时，一股血腥味混着冰味扑面而来。老铁被绑在冰柱上，胳膊上的血口子已经冻住，结了一层暗色的痂。他看见你，眼里的东西闪了一下，又拼命摇头。","尖嗓子那人说话的声音带着笑，可那笑没到眼睛里。他拔刀的动作又快又顺，像是做过无数次。刀尖扎向你胸口时，你侧身的动作慢了半拍——刀尖划在小臂上，皮肉翻开的那一刻，你才真切地感觉到疼。血涌出来的瞬间，你的左臂开始发软。"],
    options: [
  ...
  N["frontier_key_hint_1"] = {
    ...
    ,"那张告示的纸角卷着，你把它按平，又看了一遍。学院的印戳盖在落款处，朱红的印泥被雪水洇开一圈。五十金龙，对寻常人来说不是小数——可这条线索，指向的不是钱的事。","炭笔那行小字的笔画细而匀，像是读书人的手笔。你把这行字念了两遍，记在心里。禁书区、费尔曼教授、无字碑——这三个词像是三枚钉子，钉在你脑子里的地图上。"],
    options: [
  ...
  N["frontier_key_hint_3"] = {
    ...
    ,"独臂军需官翻账册的时候，手指在纸上划过，头也没抬。他说起那个姓陆的学生时，语气平淡，像在说一件旧事：“鸦羽，学院那边传的诨名。说他快，像乌鸦一样，一沾就走。”","那张通缉令的边角已经发黄，边缘磨得起了毛。他把边角递给你看时，你只来得及扫一眼画像的轮廓——画得潦草，只勾勒出个尖下巴的侧影。他说完，把边角收回去，塞进抽屉最里面。"],
    options: [
  ...
  N["frontier_seal_2"] = {
    ...
    ,"搬石头的时候，没人说话，只有石头碰石头的声音和粗重的喘息。旧铁砧很沉，两个人抬都吃力，可老兵们咬着牙，一块一块码上去。断牙老兵画那个圈的时候，嘴里念的咒含混不清，你只听清几个字，像是从哪本旧书上看来的。","黑气被压下去又渗上来，反复了三次。你蹲在石堆边守到天亮，眼睛熬得通红。天亮时裂缝没再扩大，可你心里清楚——这就像拿土埋火，火没灭，只是憋着。"],
    options: [
  ...
  N["frontier_seal_3"] = {
    ...
    ,"你搬了张凳子坐在裂缝边，离黑气三尺远。老兵们劝你离远些，你没动——你想看明白它涨落的规律。后半夜，黑气涨起来时，你数了数：涨了约莫一炷香，又退回去，像潮水。","每一次涨的时候，地底下那铁链拖地的声音就清晰一分。你竖起耳朵听，想分辨那声音的远近，可它像贴着地皮爬，忽远忽近，辨不真切。天亮时你站起来，腿麻得站不稳，可心里多少有了点数。"],
    options: [
  ...
  N["frontier_seal_4"] = {
    ...
    ,"骑马的老兵天亮出发，第三天傍晚才带着教会的人赶回来。那执事一进地窖就皱眉，让老兵们都出去，你注意到他手里提着一只银壶，壶身刻着圣纹，像是特意带来的。","他绕裂缝走那三圈时，每一步都踩得很稳，嘴里念着什么。圣水浇下去，黑气缩回去的动静，像烧红的铁淬水，嘶的一声。他临走留符纸时，你看到他手背上有几道旧疤，像是被什么东西烧过。"],
    options: [
  ...
  N["frontier_seal_after_1"] = {
    ...
    ,"断牙老兵从地窖上来时，脸上那副表情，像是见了鬼。他比划着说那些石头被从底下顶上来，自己把口子填住了——他说的时候，声音都在发飘。","你下去看了一眼：裂缝确实窄了半尺，那些石头挤在一起，像本来就长在那儿似的。黑气淡得几乎看不见，可你蹲下来闻了闻，那股硫磺味还在，像一条蛰伏的蛇。你知道，它只是睡着了。"],
    options: [
  ...
  N["frontier_seal_after_2"] = {
    ...
    ,"那行字是你自己写的，墨还没干透，就被风糊了一层雪。你伸手把那层雪抹掉，字迹洇开了一点，可还能认。你盯着“暂稳”两个字看了一会儿，心里清楚，这两个字的分量，比写出来的重得多。","断牙老兵磕烟杆的时候，火星在风里闪了一下就灭了。他走出几步，又回头说了一句：“你写归写，可这哨上的事，从来不是写了就完的。”他走远了，风把他的背影吹得模糊。"],
    options: [
      { t: "回要塞 hub", go: "frontier_city" }
    ]
  };
  ...
  N["frontier_refugee_1"] = {
    ...
    ,"流民营的油布被风掀起来一角，露出里面挤在一起的人影。那丫头画圈的手指冻得通红，可画得很认真——画一个，抹掉，再画一个，像是在记数，又像是在给自己找点事做。","她娘咳嗽的时候，整个人弓起来，被子滑到一边，露出瘦得脱了形的肩膀。小丫头跑进去喂水，水碗碰着牙，磕磕响。你站在帐篷外，看着这一幕，心里那根弦被拨了一下。"],
    options: [
  ...
  N["frontier_refugee_2"] = {
    ...
    ,"军医宋换药的手很稳，可说话的时候没有抬头。他说起雪原上那种怪病时，语气平淡得像在说天气：“不是风寒。风寒不这样烧。”他把换下来的绷带丢进火盆，火苗蹿了一下，又缩回去。","断腿老兵插话的时候，正龇牙咧嘴地活动他那条伤腿。他看了你一眼：“老钱那人，你别看他抠。他要是肯给你草根，那是把你当自己人了。”他补了一句，“他那人，认人。”"],
    options: [
  ...
  N["frontier_refugee_3"] = {
    ...
    ,"老钱嚼豆子的动作很慢，像是在把你要说的事一起嚼碎了咽下去。他说火绒花的时候，眼睛看着雪原的方向，像是能隔着雪看见那些花。","那把短镐递过来时，你注意到镐柄上的布条缠得整整齐齐，磨损的地方都换了新布——这把镐，他保养得很用心。他见你接过去，又补了一句：“花采回来，分我两朵。我留着自己泡水喝。”"],
    options: [
  ...
  N["frontier_refugee_4"] = {
    ...
    ,"冰缝里的风像刀子，你探身下去的时候，手抓着冰棱，指节冻得发白。火绒花一丛一丛长在缝壁上，白花红心，在风里颤着，看着弱不禁风，可根扎得死紧。你一朵一朵采，怀里渐渐鼓起来。","那头雪狼蹲在缝口时，你先是没看见，是风把它的气味送过来的——腥膻的，混着雪。你慢慢抬头，跟它打了个照面。它耳朵压平，尾巴慢慢竖起来，喉咙里那声呼噜又低又长。你把手里的花举了举，它没有动，只盯着你。"],
    options: [
  ...
  N["frontier_refugee_5"] = {
    ...
    ,"药煎好的时候，整个流民营都飘着那股草药味，苦中带涩。小丫头端着碗，走得又稳又慢，像捧着什么宝贝。她娘喝了药，没一会儿，手不抖了，人也睁开了眼。","小丫头从帐篷里探出头喊那嗓子的时候，声音又脆又亮，跟早晨的麻雀似的。她补的那句“给你纳双鞋”，让你一时接不上话。你摆摆手，转身走的时候，风里那点炊烟味，暖了一瞬。"],
    options: [
  ...
  N["frontier_medic_5"] = {
    ...
    ,"那本册子封皮磨得发亮，翻开来，纸页泛黄，字迹有大有小——有的记的时候手稳，有的记的时候大概手在抖。你翻到“已僵”那两个字时，指腹在纸面上停了一下。","宋说“我若北走，亦记于此”的时候，落笔很重，那一行字比前面的都深。他合上册子塞回药柜底层时，动作很轻，像是放一件易碎的东西。他站起来拍拍手上的灰，又恢复了那副忙忙叨叨的样子——可你知道，那本册子，是他的命根子。"],
    options: [
  ...
  N["frontier_mine_combat_after"] = {
    ...
    ,"老钱接短镐的时候，先看了看镐头，又拿布条缠了一圈，动作很仔细。他说“实心眼的人活得久”那话时，眼睛没看你，看着矿洞口——像是说给洞里那东西听的。","你回身看矿洞口时，黑黢黢的洞口安安静静，那水声也没了。你在哨上待了这些日子，头一回觉得，这洞口像一只合上的眼睛。你转身往要塞走，风从背后推着你，像催你走快些。"],
    options: [
      { t: "回要塞 hub", go: "frontier_city" }
    ]
  };
