...
const NODE_REGISTRY = {
  ...
  free: {
    name: "自由城邦", prefixes: ["fc", "city", "cityev", "guild", "tavern", "gangkou", "hewan", "shop", "house", "echo", "hub", "bio", "beast","herb","beast100","herb100","special","spirit","system"],
