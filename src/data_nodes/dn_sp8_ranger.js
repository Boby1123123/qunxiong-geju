...
"“学院不收钱。可它收的东西，比钱贵。”老人眯起眼，“它要你发誓：手里的弓，只对准该对准的人。”", "荒野驿站的动静在身后淡了。你把行囊带子紧了紧，继续上路。"],options:[
...
"灰衣教官盯着那点暗色看了很久：“……这不是斥候的铜钱。这是三天前，有人从学院后墙翻出去时掉的。”他收走铜钱，“第三考，跟我来。”", "你离了游侠学院沙场，脚步声在空旷处格外清晰。赶路要紧。"],options:[
...
"灰衣教官把铜钱翻来覆去看了两遍，语气缓了些：“刀有刀的活法。过。”", "游侠学院沙场的动静在身后淡了。你把行囊带子紧了紧，继续上路。"],options:[
{t:"跟上他，走向学院深处的石殿",go:"sp8_ranger_04"}
]};
...
"窗外，一轮冷月照着白墙，墙外的荒原一望无际。", "你与游侠学院作别，踏上旅途。尘土扑上靴面，像旧识。"],options:[
...
"老谢走到你面前：“说说，你听到了什么。”", "游侠学院沙场的动静在身后淡了。你把行囊带子紧了紧，继续上路。"],options:[
...
"你捡起箭囊，重新站回起射线。", "从游侠学院训练场出来，路上行人渐稀。你脚步不停，一路向前。"],options:[
...
"你照他说的调了重心，再试一轮，果然快了。",
"“你学东西快。”草蛇难得夸了一句，“荒原上，能学的都学，能活到最后的，都是杂食的。”", "你与游侠学院对练场作别，踏上旅途。尘土扑上靴面，像旧识。"],options:[
...
"你的手按上弓弦。风声正好，角度正好——可那一箭出去，就再没有回头的余地。", "荒原的灯火远了。夜风凉，你把心思收回来，专心赶路。"],options:[
...
"铁牌在你怀里硌着。你数清了粮车的数目，记下了换岗的时辰，然后悄然后撤。", "出了旧矿坑以北，风迎面扑来。你认了认方向，启程。"],options:[
...
"你收拾好行囊，站在学院的白墙下。西境的荒原在晨光里铺开，风从东边来，带着自由城邦的气息。", "游侠学院石殿的动静在身后淡了。你把行囊带子紧了紧，继续上路。"],options:[
...
"你摸了摸背上的黑弓。弓弦在风里颤了一下，像在替你自己问：接下来，往哪走？", "荒原岔路在雾里模糊了轮廓。你紧了紧衣领，迈步上路。"],options:[
...
"晨光爬上白墙时，你背起黑弓，走下石台。回头时，柯恩还站在墙头，像一棵长在风里的老树。", "游侠学院已被抛在身后。路在脚下延伸，你不回头，行至前方。"],options:[
