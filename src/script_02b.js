...
N["seraph_truth"]={tag:"branch",
  text:["塞拉芬·深渊之花。",
    "曾经的守望者高层，墨丘利的挚爱。",
    "五百年前，她试图打开第七印——不是为了毁灭，而是为了「与深渊之主对话」。",
    "她认为深渊不是纯粹的恶——它只是被误解的存在。",
    "墨丘利阻止了她。塞拉芬被封印在地下图书馆最深层。",
    "墨丘利因此离开了守望者——他至今不知道自己做对了没有。",
    "「你想见她吗？」奥雷利安问，「她还在那里——活着，但永远醒不来。」"],pace:"normal",
  options:[
...
N["prologue_choose_chengtian"]={
  place:"住处",
  text:["你选择了承天书院。","信是用毛笔写的，字迹飘逸，带着一股墨香。","信上说，承天书院在东部王国的后山，需要通过一道特殊的阵法才能进入。","随信附上了一枚玉佩，说是入门的信物。","还有一句话：「后山有时光裂隙，望汝慎之。」","【承天城开局】东境的晨光，从宫墙的琉璃瓦上滑下来。你站在承天城的大街上，看这座帝京的繁华：商铺林立，车马如流，连空气里都飘着香料和丝绸的气味。","","你身上带着东境人的印记——说话的口音，走路的姿态，连揣手的样子，都透着这座城的讲究。你知道，在这座城里，脸面就是通行证。","","街角，一个穿官服的人正训斥挑夫，声音不大，却让满街的人都低了头。你看了看那座巍峨的宫城——从今天起，你要在这里，挣出自己的前程。",""],pace:"light",
  options:[
...
N["faction_overview"]={pace:"normal",
  place:"势力总览",
...
N["faction_free_ending"]={tag:"ending",
  place:"自由城邦",
...
N["faction_north_intro"] = function(){ return {tag:"branch",
  place:"北方公国联盟·铁门关",
  text:["北方公国联盟。","七座公国，七大家族，七面旗帜。","你站在北境的城墙上，看着眼前的景象。大地是灰白色的，远处的山脉覆盖着终年不化的积雪，风从北方吹来，像刀子一样割在脸上。","北方人的性格，就像这片土地——坚硬、冷峻、不擅言辞。但他们的忠诚，也像这片土地一样深厚。","铁门关就在南边。三年前，那里还是北方最坚固的关隘。现在，它只剩下断壁残垣。","你能看到，废墟上有黑烟在升起。不是战火——是有人在废墟里生火取暖。那些是无家可归的难民，铁门关破碎后，他们失去了家园，只能在废墟里苟延残喘。","北方公国联盟的首都在霜脊城。七大公的家族都在那里，联盟议会也在那里。","但你听说，最近联盟议会吵得很厉害。有人主张全力反攻，收复铁门关；有人主张和兽人谈判，划地而治；还有人……在暗中接触教会，希望借净化令的力量巩固自己的地位。","北方不冷。冷的是人心。","你拉紧了斗篷，走下了城墙。城墙根下，一个老兵正在磨刀。他的动作很慢，很专注，像是在进行某种仪式。","你注意到，他的磨刀石上，有暗红色的痕迹。那不是锈。","是血。"],pace:"normal",
  options:[
...
N["faction_north_main"]={pace:"normal",tag:"branch",
  place:"北方公国联盟",
...
N["faction_elf_ending"]={tag:"ending",
  place:"精灵王国",
...
N["faction_dwarf_main"]={pace:"deep",
  place:"矮人王国",
...
N["faction_church_main"]={pace:"deep",tag:"branch",
  place:"光明教会",
...
N["faction_church_ending"]={pace:"deep",tag:"branch",
  place:"光明教会",
...
N["eclipse_rank_outer"] = function(){ return {
  place:"暗蚀会·外围据点",
  text:["「很好。」黑袍人说，「从今天起，你就是暗蚀会的外围成员了。」","「外围成员的任务很简单：传递消息、收集情报、做一些杂务。」","「做得好，就能晋升为正式成员。」","他递给你一个黑色的徽章：「这是你的身份凭证。不要弄丢了，也不要让外人看到。」","「你的第一个任务：去交汇城的码头，和一个穿红鞋的女人接头。」","「她会告诉你具体要做什么。」"],pace:"normal",
  options:[
...
N["eclipse_intel_mission"] = function(){ return {
  place:"暗蚀会·情报司据点",
  text:["情报司。","暗蚀会的眼睛和耳朵，负责渗透、间谍、密码、双面间谍。","情报司的司长是一个戴面具的女人，大家都叫她「蛛后」。","「欢迎加入情报司。」她的声音很轻，但你能感觉到其中的危险，「你的第一个任务：渗透艾尔达魔法学院，收集墨丘利教授的情报。」","「他是守望者的前执灯人，我们需要知道他在研究什么。」","「你能做到吗？」"],pace:"normal",
  options:[
...
N["eclipse_action_mission"] = function(){ return {
  place:"暗蚀会·行动司据点",
  text:["行动司。","暗蚀会的利刃，负责暗杀、破坏、绑架、武装行动。","行动司的司长是一个浑身伤疤的壮汉，大家叫他「屠夫」。","「欢迎加入行动司。」他的声音像磨刀一样刺耳，「你的第一个任务：去北方公国联盟，暗杀一个正在调查暗蚀会的官员。」","「做得干净点，不要留下痕迹。」","「能做到吗？」"],pace:"light",
  options:[
...
N["eclipse_research_mission"] = function(){ return {tag:"branch",
  place:"暗蚀会·研究司据点",
  text:["研究司。","暗蚀会的大脑，负责深渊魔法、邪神仪式、禁忌实验。","研究司的司长是一个看起来很斯文的中年人，大家叫他「博士」。","「欢迎加入研究司。」他推了推眼镜，「你的第一个任务：帮我完成一个深渊召唤仪式。」","「别担心，只是小规模的。」他笑了笑，「不会出什么问题的。」","实验室里，你看到了一些可怕的东西——浸泡在罐子里的器官，写满符文的墙壁，还有……一个正在蠕动的黑影。"],pace:"normal",
  options:[
...
N["eclipse_general_mission"] = function(){ return {
  place:"暗蚀会·据点",
  text:["「不选部门也行。」影说，「你可以先做一些普通任务，了解一下暗蚀会的运作。」","「普通任务包括：传递消息、运送货物、收集情报、招募新人。」","「虽然不如部门任务有前途，但胜在安全。」","他递给你一张任务清单：「自己挑一个吧。」"],pace:"light",
  options:[
...
place:"旧城区·第三条路",
text:["你不杀他，也不告发他。你选了第三条路——说服他，离开暗蚀会。", "你找到鸦，在他藏身的破屋里，与他谈了一整夜。你给他讲海底女王的故事：一个被囚禁了一万年的种族，都没有放弃自由。", "「暗蚀会能给你什么？」你问他，「一场没有胜算的报复？」", "他低着头，很久没说话。最后他开口，声音沙哑：「可我不知道，除了这条路，我还能走哪条路。」", "你从怀里摸出一块干粮，递给他：「先去吃顿饱饭。然后，往北走。那里有一座学院——你这样的年轻人，该坐在学堂里，而不是蹲在阴沟里。」", "他接过干粮，手指在发抖。他没有答应，也没有拒绝。你离开时，他站在门口，目送你消失在夜色里。", "你发现了日蚀会的另一条路——一条，和他们一贯做法，不同的路。", "你知道这件事，是因为，你无意中，听见了两个人的对话。他们在说，一件旧事——一件，用温和的办法，解决的事。", "说话的人，语气里，带着怀念：「那时候，我们不是这样的。」他说，「那时候，我们还会，坐下来谈。」他顿了顿，「现在，不坐了。」", "你躲在暗处，听着。你忽然明白，日蚀会，不是铁板一块。它里面，也有人，记得另一条路。", "你从暗处走出来的时候，那两个人，已经走了。你站在月光下，想着那番话。你在想，那条「坐下来谈」的路，现在，还走不走得通。"],pace:"normal" /*v45inj:eclipse_branch_alternative*/,
options:[
...
N["chapter_3_title"]={
  place:"第三部·大陆",
  text:["第三部·大陆。","毕业了。","你走出学院的大门，看着外面的世界。","道路在你面前延伸，通向远方。你不知道，这条路的尽头，有什么在等着你。","但你知道，你必须往前走。","因为七印正在破碎，深渊正在逼近，世界正在走向毁灭。","你必须找到铸印，找到黄林晶留下的后门，找到……拯救世界的方法。","你将走遍整个大陆——自由城邦，北方公国，南方城邦，精灵王国，矮人王国，兽人草原，东部王国，光明教会，死亡沙漠。","你将遇到各种各样的人——盟友，敌人，朋友，爱人。","你将经历各种各样的事——战斗，冒险，阴谋，背叛，救赎。","你将揭开各种各样的秘密——七印的真相，黄林晶的真相，守望者的真相，深渊的真相。","大陆很大，很危险。但你不怕。","因为你知道，你不是一个人。你有塞西莉亚，有艾伦，有蕾克斯，有影，有墨丘利，有所有你认识的人。","他们都在，以自己的方式，支持着你。","风吹过道路，带来了远方的气息。你吸了口气，朝远方走去。","你的大陆冒险，从这里开始。","而世界的命运，将在你的手中，被改写。","大陆篇，开始。"],pace:"normal",
  options:[
...
N["causality_hub"]=function(){return{place:"大陆",text:function(){
  ...
  t.push("【因果账本】你翻开账本，一页一页看过去。那些种下的因、结出的果，在你眼前排成一条清晰的线。");t.push("");t.push("有些事，是你主动做的；有些，是命运推着走的。可无论哪一种，都在这本账上记着——谁帮过你，你欠了谁；谁伤过你，你记着谁。");t.push("");t.push("你合上账本。因果这东西，看不见摸不着，可它比任何锁链都结实。你知道，你走的每一步，都在给自己铺路——也给自己挖坑。");t.push("");return t;
},options:[
