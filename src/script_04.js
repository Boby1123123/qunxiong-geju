...
place:"学院·教职工档案室",
text:["你趁教务处没人，翻出埃德蒙的人事档案。履历干净得像被擦拭过：入学、任职、晋升，每一步都合规。", "但档案袋的封口处，有一道极细的二次粘贴痕迹——有人拆开过，又重新封上了。", "你小心掀开封口，在档案夹层里摸到一张发黄的便条。上面只有一行字，笔迹与埃德蒙现在的字完全不像：", "「西格已入会。着其长期潜伏学院，观察名单变动。— T.」", "署名只有一个字母：T。", "你盯着那个字母，后背一阵发凉。T——是谁？总不会是……守望者高层。", "你把便条放回原处，重新封好档案。走出档案室时，走廊尽头，埃德蒙正站在那里，手里端着一杯茶，微笑着看你：「查资料？辛苦。」", "他笑得和平时一样温和。但你忽然看不清，那双眼睛里，到底藏着什么。", "你试探了埃德蒙一次。你想知道他，到底站在哪边。", "你故意，在他面前，提了一个敏感的名字。他听了，表情没有变化，只是手里那杯茶，停了一下。", "「你问这个做什么？」他说。你说，只是好奇。他放下茶杯，看着你：「好奇，是好事。」他顿了顿，「但好奇，也是会死人的。」", "你心里一紧。他没有再说下去。他端起茶杯，喝了一口，像什么都没发生过。你也没有再问。", "你走出门的时候，回头看了一眼。他坐在那里，还端着那杯茶，像一尊，不会动的雕像。你忽然觉得，你试探的这个人，深得，看不见底。"],pace:"normal" /*v45inj:pol_edmund_probe*/,
options:[
...
"你把它当作一段梦。只是偶尔，梦里会有封印流转的声音，轻地响着。"
],pace:"normal",
options:[
{t:"回归学院生活", go:"pol_hub"}
]
...
"你收回手。封印的光徐徐暗淡下去。你低头看着掌心的纹路，一时无言。"
],pace:"normal",
options:[
...
"你低头看，是一枚小小的铜扣，磨得发亮。你握着它，忽然觉得，三年前那个下午，隔着这么远的时间，轻落回了你的手心。"
],pace:"normal",
options:[
{t:"收下铜扣", go:"pol_hub"}
]
...
"你站在画前，看了很久。然后你伸出手，拂去画框上的灰尘，把画取了下来，卷好，带走了。"
],pace:"normal",
options:[
{t:"带着画离开", go:"pol_hub"}
]
...
, "后来你才知道，这种纹路，老人们叫它「深渊标记」。他们说这个词的时候，声音会压低，眼神会避开——仿佛念出名字，就会引来什么。", "你把袖子放下来，遮住那道纹路。你告诉自己，不过是条旧疤。可你知道，疤不会自己长。"/*v46txt:abyss1*/],pace:"normal",
options:[
{t:"留意这个标记", go:"pol_hub"}
]
}};
...
"你握着罗盘，指针轻颤动，像在回应你。你把它系在腰间，从此无论走到多深的地下，你都知道——有一枚指针，永远指着回家的方向。"
],pace:"normal",
options:[
...
"明天晚上，就是动手的时候。你吸了口气，海风灌进肺里，又咸又冷。你知道，这一夜之后，很多事都会不一样。"
],pace:"normal",
options:[
...
"晨风拂过脸颊，带着田野的气息。你吸了口气，加快脚步。前方，大陆的版图正徐徐展开——你毕业了，但你的故事，才刚刚开始。"
],pace:"normal",
options:[
