...
function loadGame(){
  try{
    const d = StorageKit.load(S && S.slotId ? S.slotId : "slot1");
    if(!d){ flashMsg("没有找到存档"); return; }
...
/* ============ 叙事渲染 ============ */
let storyEl, optEl, curNode=null;
function jobMat(i){
...
function showOptions(node){
  ...
  for(let i=0;i<opts.length;i++){
    ...
    let html = "<span class='od'>◆</span> "+rich(o.t);
    if(o.check){
      const t = effTarget(o);
...
var FINAL_FORESHADOWING_V47 = {
  ...
  watcher_spy: {name:"守望者密探", reveal:[
    "你想起序章里那道注视的目光。后来你才明白，那目光不属于任何你认识的人——它属于一座塔。",
  ...
  origin_clue: {name:"身世线索", reveal:[
    "母亲的旧物、陌生人注视的目光、档案里那行被水渍模糊的字——它们指向同一个地方。",
  ...
  function openPathChoice(){
    try{
      ...
      if(rs&&rs.length){ h+="<div style='margin-top:10px'><b>种族专属转职</b>";
        for(var j=0;j<rs.length;j++){ h+="<div style='padding:6px;border:1px solid #8b6f47;border-radius:6px;margin:4px 0;background:rgba(139,111,71,.08)'><b>"+rs[j].sub+" → "+rs[j].cls+"</b> <span class='mini'>"+rs[j].note+"</span> <button class='btn' style='float:right' onclick='v488_pickSub(\"race_"+rs[j].sub+"\",\""+rs[j].cls+"\")'>转职</button></div>"; }
        h+="</div>"; }
    ...
    }catch(e){ if(window.ErrorLog&&ErrorLog.record) try{ ErrorLog.record(e); }catch(e2){} }
  }
...
"窗外起风了，吹得窗纸哗哗响。你忽然觉得，那不是风——是墙外整条河的水在应你。"
],
...
"可你已经看见了。而且你确定——那行字，刚才在你读它的时候，笔画动了一下。"
],
...
"你捡起那颗银珠。它温热，像刚出锅的糖。",
"门被推开，导师拎着酒壶进来：'怎么样？'",
"'成了。'你说。你没提那颗银珠——它正躺在你口袋里，贴着皮肤，微微发烫。"
],
...
"你把酒桶搬起来，快步走出门。掌心的红已经褪了，只留一点热，像刚握过冬天的火。"
],
...
"你把手按在剑柄上。剑不动。可你的手腕自己记住了什么，贴着剑柄的弧度，缓缓转了一圈。",
"陈列厅的门吱呀一声。你飞快地收回手。进来的管理员看了一眼那把剑，又看看你，说了句：'那把剑，三十多年没人能拔出来了。'",
"他没有问你在做什么。你也没有说——你手掌贴着剑柄那一下，指腹上多了一道浅浅的印子，像剑鞘里的纹路，正等着你的手。"
],
...
"你低头看自己的手。指尖还沾着沙。刚才那局棋，你每一步都像早就下过。"
],
...
"你转身走出地下走廊。阳光照在你脸上，你眯起眼，手心的汗把钥匙柄浸得发滑。"
],
...
"你顺着它的目光看过去。草垛底下蜷着一只灰猫，瘦得皮包骨，一条腿折了，拖在身后。",
...
"只有你记得，它趴在你膝上的时候，尾巴尖轻轻扫了扫你的手腕——像在记你的味道。"
],
...
"你摇头：'不知道。就是想这么做。'",
"你的指尖还在发凉。窗外开始下雨，雨点打在接水盆里，叮叮当当。那盆里的水，忽然清了一寸。"
],
...
"你低头，发现自己手里攥着一样东西——不知什么时候，你从门框上抠下了一块木屑，攥得掌心发白。"
],
...
"你走出账房，太阳很好。你发现自己的手指在发烫——不是握算盘握的，是你刚才顺着那两行数字往下看的时候，心里有什么东西，像一把锁，被一串数字轻轻拨开了。"
],
...
/*v489inj:abyss*/
N["abyss_mage_0"]=function(){return{
place:"深夜 · 无人的角落",
...
N["abyss_mage_1"]=function(){return{
place:"同一个角落 · 第二夜",
req:{mat:"深渊封印石",n:1},
...
N["abyss_soul_0"]=function(){return{
place:"深夜 · 无人的角落",
...
N["abyss_soul_1"]=function(){return{
place:"同一个角落 · 第二夜",
req:{mat:"缚魂丝",n:1},
...
N["abyss_knight_0"]=function(){return{
place:"深夜 · 无人的角落",
...
N["abyss_knight_1"]=function(){return{
place:"同一个角落 · 第二夜",
req:{mat:"黑曜石刀片",n:1},
...
N["abyss_ranger_0"]=function(){return{
place:"深夜 · 无人的角落",
...
N["abyss_ranger_1"]=function(){return{
place:"同一个角落 · 第二夜",
req:{mat:"腐化獠牙",n:1},
...
N["abyss_thief_0"]=function(){return{
place:"深夜 · 无人的角落",
...
N["abyss_thief_1"]=function(){return{
place:"同一个角落 · 第二夜",
req:{mat:"影丝",n:1},
...
N["abyss_priest_0"]=function(){return{
place:"深夜 · 无人的角落",
...
N["abyss_priest_1"]=function(){return{
place:"同一个角落 · 第二夜",
req:{mat:"倒悬钟印",n:1},
...
N["abyss_merch_0"]=function(){return{
place:"深夜 · 无人的角落",
...
N["abyss_merch_1"]=function(){return{
place:"同一个角落 · 第二夜",
req:{mat:"黑币",n:1},
...
place:"静室 · 灯下",
text:["你闭着眼，把今天学的法术在脑子里过了一遍。第三遍的时候，你忽然闻见一股墨水味，很淡，像谁刚写完一页字。", "你睁开眼。房间空无一人，桌上那支没用过的羽毛笔，笔尖上凝着一滴墨，正在往下滴。", "你伸手接住。墨滴落进掌心，没有晕开，凝成一颗圆圆的珠子，像一只闭着的眼睛。", "你听见一个声音，很轻，像隔着一千年的纸传过来的：'写字的笔，认字的手。'", "珠子在你掌心化开，渗进皮肤，只留下一圈淡青色的印子。", "你闻到的墨水味散了。你摊开书，翻到扉页——上面有一行字，不是你写的：'奥术不认血缘，认的是破开真相的执念。'", "你盯着那行字。墨迹很新，像刚刚落笔。"],
options:[{t:"把这段感应记在心里", go:"sub_path_hub"},
{t:"循着那一点牵引，再坐一阵", go:"deity_mage_1"}]}};

N["deity_mage_1"]=function(){return{
place:"静室 · 更深",
text:["你伸手去摸那行字。指尖触到纸面，字迹微微凸起，像烙进纸里的。", "你合上书，又翻开。字还在。", "你想起一个传说：两千年前，奥术之主陨落，他的王座空了千年，没有一个法师敢坐上去。", "你摸着自己掌心的淡青色印子，忽然明白，那条路不是没人走，是走了的人，都没回来。", "你吹灭灯，在黑暗里坐了很久。窗外有风，吹得窗纸沙沙响。", "你听见自己的心跳，一声一声，很稳。"],
options:[{t:"起身，把这夜收好", go:"sub_path_hub"}]}};

N["deity_soul_0"]=function(){return{
place:"静室 · 灯下",
text:["你打坐的时候，眼前总会浮起一片光。不是烛光，不是日光，像清晨第一线从天边渗进来的白，很薄，很凉。", "你睁开眼，光就散了。房间里还是那盏灯，灯芯烧得发黑。", "你闭上眼，光又回来。这一次，光里有一个模糊的影子，轮廓很淡，像在跟你说什么，但你听不见。", "你试着向前走一步。光里的影子退一步。你再走，它再退。", "你停下来。影子也停下来。它抬手，指了指你自己。", "你低头看自己——你站在一片光里，脚边有一圈淡淡的影子，形状和你一模一样。", "你睁开眼。灯还亮着。你发现自己的影子，在灯下，比平时淡了一点。"],
options:[{t:"把这段感应记在心里", go:"sub_path_hub"},
{t:"循着那一点牵引，再坐一阵", go:"deity_soul_1"}]}};

N["deity_soul_1"]=function(){return{
place:"静室 · 更深",
text:["你看着灯下自己淡了一圈的影子，心里忽然浮起一个名字：晨曦。", "你听过那个传说：一个灵魂法师，没有登神，没有神位，只是把自己的名字刻在黎明前最薄的那层光里。", "你的影子晃了晃。你看见影子的手，慢慢抬起来，指向窗外。窗外，天边泛起一线白。", "天快亮了。你坐在窗前，看着那线白一点一点漫开。", "你的影子，在天亮之前，慢慢变回原来的颜色。", "你站起身，没有点灯。你借着那线晨光，收拾好桌案。桌上有一面小镜，镜子里你的脸，被晨光照得很清楚。", "你看了自己很久。你没有问晨曦是谁。你只记得，那片光里的影子，指了一下你自己。"],
options:[{t:"起身，把这夜收好", go:"sub_path_hub"}]}};

N["deity_sor_0"]=function(){return{
place:"静室 · 灯下",
text:["你修补一口旧锅的时候，炉火忽然静下来。不是熄灭，是火焰竖成一条线，安安静静地烧。", "你握着钳子的手，停在半空。你听见火里有一个声音，像铁在锻打时发出的那种闷响：'熔炉记得每一双手。'", "你低头看自己的手。手背的烫疤是去年留下的，已经白了。", "火焰动了一下，像有谁在火里翻动。你看见火舌的缝隙里，躺着一粒通红的铁块，小指头大小，圆滚滚的。", "你用钳子夹出来。铁块在空气中迅速冷却，变成灰黑色。你握在手里，它还热着。", "你把它放在工作台上，继续补锅。补完锅，你再去看——铁块还在，但它不再烫了，静静地躺着，像一颗烧过的种子。", "你把铁块收进口袋。走出工坊，暮色里，你回头看了一眼炉火——火焰已经恢复正常，烧得噼啪响。"],
options:[{t:"把这段感应记在心里", go:"sub_path_hub"},
{t:"循着那一点牵引，再坐一阵", go:"deity_sor_1"}]}};

N["deity_sor_1"]=function(){return{
place:"静室 · 更深",
text:["夜里你坐在工作台前，把那粒铁块放在灯下。", "你想起矮人王的传说：锻造之神陨落时，把最后一点神火交给了一个半神，名叫索林·铁须。那点火，据说能认出真正的工匠。", "你捏起铁块。它凉了一整天，可当你把它贴近胸口的时候，它又热起来。", "你没有问它要什么。你把它放在台子上，开始打一枚铜钉。", "铜钉打好，你把它和铁块并排放在一起。铁块的热，慢慢漫过来，把铜钉也烘得温温的。", "你看着这两样东西，忽然觉得，它们像认识了很久。", "你吹灭灯。黑暗里，铁块发出一点极暗的红光，像埋着的一粒火种。"],
options:[{t:"起身，把这夜收好", go:"sub_path_hub"}]}};

N["deity_war_0"]=function(){return{
place:"静室 · 灯下",
text:["你练刀练到力竭，靠在演武场的木桩上喘气。", "夕阳把你的影子拉得很长。你看着自己的影子，忽然觉得，那道影子比你壮——不是错觉，影子的肩，比你宽了半寸。", "你站直。影子也站直。你举起手，影子举起手。动作一致，但影子的动作，总是快你一线。", "你盯着那道影子，影子也像在看你。", "你想起一个老兵的传说：战神陨落三千年，他的战意没有散，沉在大陆的每一把刀里。握刀的人，都会梦见同一个战场。", "你低头看自己的刀。刀身上，夕阳的余光镀了一层金。", "你收刀入鞘。影子缩回你脚下。你走出演武场，脚步比来时重了一点。"],
options:[{t:"把这段感应记在心里", go:"sub_path_hub"},
{t:"循着那一点牵引，再坐一阵", go:"deity_war_1"}]}};

N["deity_war_1"]=function(){return{
place:"静室 · 更深",
text:["夜里你睡不着，把刀放在枕边。", "月光从窗缝漏进来，照在刀身上。你看见刀身上有一道极淡的划痕，白天没有的。", "你坐起来，把刀横在膝上。月光下，刀身的划痕慢慢连成一条线，像一幅地图的边。", "你的手，自己按在了那道线上。", "你听见一阵极远的风声，像从几千里外的高原上吹来的。风声里，有一个声音说：'战场不认输家。'", "你松开手。划痕还在。", "你重新躺下，把刀放回枕边。月光照着刀身，那道线安安静静的，像在等你。", "你闭上眼。梦里，你站在一片草原上，风很大，远处有一面破旗，在风里猎猎作响。"],
options:[{t:"起身，把这夜收好", go:"sub_path_hub"}]}};

N["deity_knight_0"]=function(){return{
place:"静室 · 灯下",
text:["你帮教堂修整围栏时，在墙根底下刨出一块旧石碑。石碑半截埋在土里，字迹已经磨平了。", "你用水洗净碑面，发现最上面刻着一行字，笔画很浅，像刻的人故意不用力：'立誓之人，其誓不移。'", "你蹲在碑前，把那行字念了一遍。", "念完，你听见一声极轻的响，像什么东西在你胸腔里应了一声。你按住胸口，心跳很正常。", "你继续修围栏。可那行字在你脑子里转了一下午。", "傍晚，你把石碑立回墙根，用土培好。你站起来的时候，发现自己不知什么时候，把左手按在了碑面上，像在按着什么起誓。", "你收回手。碑面上，多了一个淡淡的掌印。"],
options:[{t:"把这段感应记在心里", go:"sub_path_hub"},
{t:"循着那一点牵引，再坐一阵", go:"deity_knight_1"}]}};

N["deity_knight_1"]=function(){return{
place:"静室 · 更深",
text:["你夜里又去了教堂。月光下，那块石碑上的掌印还在。", "你蹲下来，把自己的手覆上去。掌印严丝合缝——就是你的手。", "你听见碑里传来一个声音，很轻，像隔着很厚的墙：'誓约之神在位千年，从没有人见过他。'", "你问：'那他还在吗？'", "声音没有回答。但碑面上，那行字的下方，慢慢浮现出一行新字，笔画和原刻一样浅：'还在。在等一个立誓的人。'", "你收回手。那行新字没有消失。", "你走出教堂，夜风很凉。你回头看了一眼——石碑立在月光里，安安静静的。", "你摸着自己的左手。掌心的纹路，比白天深了一点，像被什么按过。"],
options:[{t:"起身，把这夜收好", go:"sub_path_hub"}]}};

N["deity_ranger_0"]=function(){return{
place:"静室 · 灯下",
text:["你巡林的时候，在一棵老树洞里发现一窝雏鸟。鸟妈妈不在，雏鸟饿得直叫。", "你抓了几条虫，喂给它们。喂完，你发现树洞边沿，刻着一个极淡的记号，像一片叶子，又像一枚脚印。", "你顺着记号的方向走。走了一里地，记号消失了，你站在一片你从没到过的空地中央。", "空地上没有树，只有一片草，草长得整整齐齐，像被谁修剪过。", "你蹲下来摸那草。草叶是凉的，但草根是温的。", "你听见风声。风里有一个声音，不像人，像整个林子同时开口：'荒野之神不立庙，不进香。他的庙，是每条没人踩出来的路。'", "你站起来。风吹过空地，草叶一起一伏。", "你沿着来路走回树洞。雏鸟已经睡了，鸟妈妈不知什么时候回来了，正蹲在枝头看你。"],
options:[{t:"把这段感应记在心里", go:"sub_path_hub"},
{t:"循着那一点牵引，再坐一阵", go:"deity_ranger_1"}]}};

N["deity_ranger_1"]=function(){return{
place:"静室 · 更深",
text:["你坐在树洞边，看着鸟妈妈喂雏鸟。", "你想起那个传说：荒野之神在位，可他从没有教廷，没有圣像，连名字都很少有人知道。", "你问枝头的鸟妈妈：'你见过他吗？'", "鸟妈妈歪了歪头，没有回答。它跳下枝头，在地上啄了一下，又飞回去。", "你蹲下来，看它啄过的地方。土里埋着一粒种子，已经发了芽。", "你小心地把种子旁边的土拨松，让它透透气。", "你做完这些，站起身，准备离开。走出几步，你听见身后传来一声极轻的响——不是鸟叫，像一颗种子破土的声音。", "你回头。那棵新芽，在夕阳里，叶尖上凝着一粒水珠，亮晶晶的。"],
options:[{t:"起身，把这夜收好", go:"sub_path_hub"}]}};

N["deity_thief_0"]=function(){return{
place:"静室 · 灯下",
text:["你替学院跑腿送信，路过一条你没走过的小巷。巷子很窄，墙根堆着旧物，尽头是一扇漆皮剥落的门。", "门缝里漏出一线光。你凑近看，里面不是房间，是一条向下的楼梯，光从楼梯尽头透上来。", "你没有推门。你记住了这条巷子的位置，继续送信。", "回来的时候，你故意又走了一次这条巷子。门还在，光还亮着。", "第三次，你蹲在门口，仔细看那扇门。门板上没有锁，只有一个极小的刻痕，像一只闭着的眼睛。", "你伸手摸那只眼睛。刻痕是凉的，可你指尖刚碰到，门缝里的光，晃了一下。", "你收回手。光又稳住了。你听见楼梯尽头传来一个声音，很轻，像有人笑了一下，又像没有。"],
options:[{t:"把这段感应记在心里", go:"sub_path_hub"},
{t:"循着那一点牵引，再坐一阵", go:"deity_thief_1"}]}};

N["deity_thief_1"]=function(){return{
place:"静室 · 更深",
text:["你第四次来到那扇门前，终于推开了它。", "楼梯很陡，光从底下照上来，把你的影子拉得很长。你走到底，看见一间很小的房间，空荡荡的，只有一张桌子，桌上放着一面铜镜。", "你凑近看。镜子里没有你的脸——镜面是空的，像蒙了一层雾。", "你伸手擦。雾散开一点，镜面里出现一行字，字迹很淡：'隐秘之主的神位，空了三十年。'", "你盯着那行字。字迹像会呼吸，慢慢淡下去，又浮起来。", "你听见自己心里有个声音问：'谁坐上去，谁就看不见了。你怕吗？'", "你没有回答。你退出房间，爬上楼梯，把门轻轻合上。", "走出小巷，太阳很亮。你低头，看见自己的影子，比平时淡了一点，像那扇门里的光，在你身上留了一道印子。"],
options:[{t:"起身，把这夜收好", go:"sub_path_hub"}]}};

N["deity_priest_0"]=function(){return{
place:"静室 · 灯下",
text:["你做完晚祷，最后一个走出教堂。", "夕阳正好落在圣坛上，把圣像染成金色。你看见圣像的指尖，凝着一粒光，像一滴露水，又像一粒泪。", "你走过去看。光粒是温的，你伸手，它落在你掌心，没有化开，像一颗小小的太阳。", "你听见钟声——不是晚钟，是一声你从没听过的钟鸣，又远又近，像从云层上面传下来的。", "钟声过后，圣像的指尖，光粒消失了。你掌心那粒光，还在。", "你把它贴在胸口。它隔着衣料，微微发热，像一颗跳动的心。", "走出教堂时，晚风很凉。你掌心的光，一直温着。"],
options:[{t:"把这段感应记在心里", go:"sub_path_hub"},
{t:"循着那一点牵引，再坐一阵", go:"deity_priest_1"}]}};

N["deity_priest_1"]=function(){return{
place:"静室 · 更深",
text:["夜里你跪在圣坛前，掌心的光粒还在发热。", "你问圣像：'太阳神圣辉，在位千年，从不显圣。为什么是我？'", "圣像没有回答。但你听见一个声音，像从很远的天顶传下来的：'太阳不认信徒。太阳认的是早起的人。'", "你愣了很久。你想起自己每天清晨第一个进教堂，打扫，点烛，从没间断。", "掌心的光粒化开了，渗进你的皮肤，留下一圈淡淡的金色印子，像被太阳晒过。", "你低头看着那圈印子。钟楼敲响子时的钟，一声一声，很沉。", "你站起来，把烛台添满油。你走出去的时候，回头看了一眼圣像——夕阳的光已经没了，但圣像的指尖，还亮着一点。"],
options:[{t:"起身，把这夜收好", go:"sub_path_hub"}]}};

N["deity_merch_0"]=function(){return{
place:"静室 · 灯下",
text:["你替食堂算这个月的账，算到最后，总数差了三个铜币。", "你重新算了两遍，还是差三个。你翻进货单，一笔一笔核对，最后发现——上个月的账，多记了三笔支出，每笔正好一个铜币。", "这三笔支出，不是你记的。你翻到上个月的账页，墨迹已经干了，但笔迹不对——比你写的轻，像谁在你记完账之后，添上去的。", "你把那三笔划掉，重新合计，数字对上了。", "合上账本的瞬间，你听见一声极轻的响，像秤杆在桌上顿了一下。", "你抬头。账房里只有你一个人。桌上那杆旧秤，秤砣自己摆正了，像被谁扶了一下。"],
options:[{t:"把这段感应记在心里", go:"sub_path_hub"},
{t:"循着那一点牵引，再坐一阵", go:"deity_merch_1"}]}};

N["deity_merch_1"]=function(){return{
place:"静室 · 更深",
text:["你盯着那杆秤看了很久。它摆正之后，就再没动过。", "你走过去，伸手摸了摸秤杆。秤杆是温的——账房里很冷，可它温得像被人握过。", "你听见一个声音，像铜钱碰铜钱的声音，又轻又脆：'金衡在位，管的不是钱。'", "你问：'那管什么？'", "那个声音停了很久，才说：'管秤。秤平了，钱才有路。'", "你收回手。秤杆的温热，慢慢退去。", "你走出账房。月光下，你看见自己手里，不知什么时候多了一枚铜币——不是你的，是刚才那三笔账里，被划掉的其中一笔。", "你把它放回账本的夹页里。那杆秤，在月光下静静地立着，秤砣稳稳地悬在正中。"],
options:[{t:"起身，把这夜收好", go:"sub_path_hub"}]}};
...
place:"风炉间 · 元素共鸣",
req:{mat:"火晶尘",n:1},
text:["第二天你再去风炉间，导师不在。炉膛里压着一块炭，还是温的。", "你按昨天的手感添了一把火晶粉。这一次，火光没有炸开——它在炉壁上凝成一道细细的纹路，像血管，缓缓爬了半圈。", "你伸手碰那道纹。指尖传来一阵酥麻，像握着一条温顺的河。", "你试着让火沿着纹路走。它走了三步，停在你指尖下，微微发烫，等你下一个念头。", "导师回来时，炉膛已经冷了。他看了一眼炉壁上的纹，没有说话，只把一串钥匙放在台子上：'以后风炉间归你管。'", "你收好钥匙。钥匙上拴着一枚铜环，环里嵌着一粒火晶，红得发亮。"],
...
place:"杂物间 · 空间练习",
req:{mat:"旧纸人",n:1},
text:["杂物间最里面的柜子，门缝里夹着一截黄纸。你抽出来，纸上画着一个人形，笔迹歪歪扭扭，像小孩画的。", "你照着纸人画了一个。画完，纸人自己立了起来，歪着头看你。", "你试着让它走一步。它摇摇晃晃迈出一步，撞在柜脚上，倒了下去。", "你把它扶起来，重新画了双腿。这一次，它走了三步，稳稳地站在你面前。", "你听见柜子里传来一声极轻的笑。你拉开柜门——里面只有旧书和灰，什么都没有。", "你合上柜门。纸人还站在地上，抬着手，像在等你给它一个去处。"],
...
place:"档案室 · 结界试炼",
req:{mat:"静默墨",n:1},
text:["你借到一卷旧结界图，纸张脆得像枯叶。图边有一行小字：'静默结界，以无声封有声。'", "你在档案室角落练习。念诀，落印。结界张开的一瞬，你听见自己的心跳声消失了。", "你试着在结界里咳嗽一声。声音没有传出去，连你自己都听不见——像被吸进墙里。", "你撤去结界。心跳声回来了，像迟到的钟。", "你卷好结界图，放回书架时，发现封脊里夹着一页纸，上面抄着一句：'结界不是墙，是沉默本身。'", "你把那页纸夹回原处，没有带走。走出档案室，你发现自己的脚步声，比平时轻了半拍。"],
...
place:"后山坟场 · 初试",
req:{mat:"骨灰",n:1},
text:["你带着那支骨笛，又去了后山坟场。月光下，坟场的草齐刷刷地伏着，像在等什么。", "你吹了一下骨笛。没有声音——但草尖齐齐颤了一下。", "你握着银线，试着让它往坟场深处走。银线悬在草尖上，缓缓游过一座座坟头，停在一棵老槐树下。", "槐树下，草色比别处深。你走过去，看见土里露出一角木匣，匣盖半朽，刻着一行字：'还我。'", "你没有挖它。你跪下来，把银线缠在槐树根上，绕了三圈。", "银线贴着树根，微微发亮，像一根细细的脉搏。你听见地底传来一声很轻的叹息，像放下了什么。"],
...
place:"钟楼 · 记忆回廊",
req:{mat:"旧钟绳",n:1},
text:["你站在钟楼底下，把心静下来。", "你试着像那天一样，去听。起先只有风声，后来，你听见一声很远的钟响——不是敲的，是回声，像从很多年前传过来的。", "你顺着回声走。钟楼的石阶上，你看见一双脚印，比你小，比你的旧。脚印停在三楼，转向一扇封死的窗。", "你推开窗。窗外没有风景，只有一片灰蒙蒙的光，光里站着一个影子，看不清脸。", "它抬手指了指钟楼顶上。你抬头——顶上悬着一口旧钟，钟舌上系着一根红绳，褪成了白色。", "你没有碰那根绳。你退出来，合上窗。那口钟，在你身后，轻轻响了一下。"],
...
place:"医务室 · 烛火练习",
req:{mat:"烛泪",n:1},
text:["医务室的医师借给你一支旧烛台。你说要练专注，他点点头，什么也没问。", "你对着烛火练习。火苗起初跳个不停，你盯着它，盯到眼睛发酸。", "第三天，火苗静了下来，直直地立着，像被什么按住了。", "你试着让火苗往左偏。它偏了。往右。它又偏回去。", "你听见医师在门口站了一会儿。他没有进来，只留下一句话：'别把火用在自己人身上。'", "你吹灭烛火。房间暗下来，你的眼睛还亮着——你知道，那不是烛光。"],
...
place:"阅览室 · 契约",
req:{mat:"契约纸",n:1},
text:["阅览室角落有一本旧书，书脊上没有字。你抽出来，翻到最后一页——空白页上，画着一只手，掌心朝上。", "你把自己的手覆上去。纸面凹下去一点，像另一只手在下面托着你。", "你想起缚魂者的传说：与什么立约，就要把自己的一部分交给它。", "你问：'你是谁？'", "纸面上浮出一行字，笔画很淡：'你还没准备好知道。'", "你把手收回来。纸上的手印还在，掌心的纹路，和你的手一模一样。", "你合上书，放回原处。走出阅览室，你发现自己的左手心，多了一道浅浅的纹，像被什么握过。"],
...
place:"蒸馏台 · 银液成丹",
req:{mat:"银液",n:1},
text:["你把那瓶用不完的银液倒回坩埚，重新加热。", "这一次，银液没有沸腾，而是慢慢收拢，凝成一粒拇指大的珠子，悬在锅底。", "你把它取出来。珠子是温的，表面有一层细纹，像纹章。", "你把它放进药柜。第二天，药柜里多了一瓶药，标签上写着：'取珠者自用。'笔迹不是你的。", "你打开药瓶闻了闻——是你那粒珠子化开的气味，带着一丝苦，一丝甜。", "你把它收进怀里。夜里你梦见自己站在一口更大的坩埚前，锅沿刻着一行字：'万物都可成药。'"],
...
place:"铁匠铺 · 锻造契约",
req:{mat:"精铁块",n:1},
text:["你带着那把浮出金纹的短刀，去了铁匠铺。老铁匠看了看金纹，说：'火认了你。'", "他指着一块生铁：'用你的纹，给它开一条路。'", "你把短刀贴上去。金纹顺着铁面爬开，像水渗进沙里。铁块表面，慢慢浮出一层暗金色的纹路。", "你把它放进炉里。出炉时，铁块成了一枚铁环，环上刻着一圈细纹，和你的金纹一样。", "老铁匠把铁环套在你手腕上：'火认人，铁也认。它认了你，就不会背叛你。'", "你走出铁匠铺。铁环贴着皮肤，凉了一下，又热起来，像一颗活着的心跳。"],
...
place:"地下车间 · 认主",
req:{mat:"黄铜齿轮",n:1},
text:["那只机械鸟又来找你了。它蹲在工作台上，歪着头，啄了啄你摊开的图纸。", "你给它换了一枚新齿轮。它试着扇了扇翅膀，发出一种新的、更顺滑的响声。", "你试着给它一个指令：'去窗台上。'", "它飞起来，落在窗台上，回头看你，像在等下一句。", "你又下了一个指令：'回来。'它飞回你的肩头，收拢翅膀，安静地站着。", "你摸了摸它的脑袋。它用喙轻轻啄了啄你的指尖，像在记你的味道。", "你听见车间深处传来一声极轻的齿轮声，像什么被启动了。"],
...
place:"储酒室 · 共鸣",
req:{mat:"兽血",n:1},
text:["储酒室的旧酒桶底下，压着一块黑石。你搬开酒桶，黑石表面浮着一层暗红的光，像血没干透。", "你蹲下来，伸手碰它。指尖刚触到，你心里涌起一阵陌生的燥热，从胸口往上爬。", "你收手。燥热退下去，但你的心跳比平时快了半拍。", "你听见一个声音，从你自己身体里传出来的：'你身上，有和它一样的东西。'", "你把黑石放回原处，搬回酒桶。走出储酒室，你发现自己的掌心，多了一道暗红色的线，像血管浮出皮肤。", "你用袖子盖住它。那道线贴着皮肤，温温的，像在应你。"],
...
place:"演武场 · 怒意收放",
req:{mat:"狂兽之牙",n:1},
text:["演武场的木桩换了一根新的，教官说：'先打它一百下，再说话。'", "你打到第四十下的时候，心里那团火又拱上来。你听见自己的呼吸变粗，眼前发红。", "你停下来。教官站在旁边，没有说话。", "你站在原地，把呼吸放慢，一下，一下。火气没有散，但它不再拱了——它在你心里蹲下来，像一头被驯住的兽。", "你重新举起拳。这一拳，没有刚才的重，但木桩上，留下了一个更深的印子。", "教官点点头：'今天教你的是——怒意是你的，别让它骑在你头上。'", "你走出演武场。晚风一吹，你才发现后背全湿了。"],
...
place:"武库 · 手感",
req:{mat:"旧剑刃",n:1},
text:["武库的墙上挂满了兵器。你走过去，挨个摸了一遍。", "摸到第三把剑的时候，你的手自己停住了——不是你想停，是剑柄的重量，刚好压在你掌心最稳的地方。", "你拔出来试了试。剑不重，也不轻，像为你量过。", "你练了一下午。收剑的时候，你发现自己的手腕，学会了三个新的发力点——不是书上教的，是剑自己告诉你的。", "武库的看守坐在门口，抽着烟：'挑兵器就像挑人，合不合适的，手知道。'", "你把剑放回架上，只记下了它的位置。你走出武库，手还在发痒。"],
...
place:"箭楼 · 盾墙防线",
req:{mat:"铁钉",n:1},
text:["箭楼的哨兵借给你一面旧盾。盾面上坑坑洼洼，全是箭痕。", "你举盾，试着挡住射来的木箭。第一轮，你中了三箭。", "你蹲下来，调整了重心——把盾脚扎进土里，肩胛抵住盾背，像一堵墙那样站住。", "第二轮，木箭全被弹开，叮叮当当落了一地。", "哨兵拍了拍盾面：'盾不是挡箭的，是让后面的人不用挡箭的。'", "你把盾还回去。走下箭楼，你的肩胛骨还在发烫，像刚被什么东西撑开过。"],
...
place:"沙盘室 · 布阵",
req:{mat:"旧军旗",n:1},
text:["沙盘室的沙盘上，插着几面小旗。教官说：'给你一队人，你布个阵。'", "你把旗子拔了重插——盾在前，弓在侧，留一条后路。", "教官看着沙盘，没有评价。他推倒你一面旗，模拟敌军绕后。", "你重新布。这一次，你把自己的主旗，放进了最不显眼的位置。", "教官笑了：'记住，为将者，不站最高处。'", "他走后，你站在沙盘前，看着那面小小的主旗，在心里把那句话又默了一遍。"],
...
place:"教堂后园 · 圣光初绽",
req:{mat:"圣城长明灯芯",n:1},
text:["你帮教堂修围栏的时候，那块石碑还立在墙根。你路过，又看了一眼那行字：'立誓之人，其誓不移。'", "你蹲下来，把左手按在碑上。", "这一次，你的手没有发凉。碑面上，你的掌印边缘，泛起一层极淡的白光，像清晨的雾。", "你缩回手。光散了。但你看见自己的指尖，还留着一线白，像没退尽的月光。", "你站起来，试着握拳。那一线白，顺着指缝，流进你的掌心，消失了。", "你走出教堂。晚风里，你发现自己握拳的时候，心里比平时稳了一点。"],
...
place:"教堂侧廊 · 圣盾",
req:{mat:"圣水",n:1},
text:["你路过侧廊，又看见那个老妇。她这次没有跪着，坐在长椅上，身边放着一块干饼，没动。", "你走过去，把外套脱下来，披在她肩上。", "她抬头看你。眼睛还是干干的，但她伸手，掰了半块饼，递给你。", "你接过来。饼是冷的，硬邦邦的。你咬了一口。", "你咬下那一口的时候，胸口涌起一阵热，像有什么东西，在你心里立了起来——不是墙，是一面盾。", "老妇看着你，慢慢笑了。她的眼睛还是干的，但嘴角的皱纹，像被什么撑开了一点。", "你走出教堂。披在她肩上的外套，在风里轻轻晃着。"],
...
place:"城郊 · 就地审判",
req:{mat:"驿道图",n:1},
text:["你在城郊的路上，遇见两兄妹在争吵。哥哥攥着一袋铜币，妹妹蹲在地上哭。", "你停下来听。哥哥说钱是爹留的，该他管；妹妹说钱是治娘病的，该拿去请大夫。", "你没有立刻开口。你蹲下来，问妹妹：'大夫请了吗？'", "妹妹摇头，指着城里的方向：'请不起。'", "你从自己怀里摸出几枚铜币，放进妹妹手里，又转向哥哥：'钱先治病。治完了，剩下的，你们再分。'", "哥哥愣了愣，把袋子里的铜币倒了一半出来，递给你：'借的，记你账上。'", "你摇摇头，没有接。你站起来，继续赶路。走出很远，你回头，看见那对兄妹还站在路边，哥哥在给妹妹擦眼泪。"],
...
place:"地牢 · 第一声回应",
req:{mat:"黑曜石刀片",n:1},
text:["你带着那把钥匙，又去了地牢。", "你站在铁门前，没有开门，只是把钥匙握在手心。黑布还缠着，那角温的，还在。", "你问：'你是谁？'", "地牢深处，传来一声拖长的回音。这一次，你听清了——不是铁器刮壁，是有人在哼一支歌，调子很旧，像小时候听过的。", "你攥紧钥匙。黑布底下，那枚倒悬乌鸦的记号，在你掌心，微微发烫。", "你没有开门。你把钥匙收回口袋，退出走廊。", "阳光照在你脸上。你发现自己的手指，不受控制地在裤腿上，画了一个记号——倒悬的乌鸦。", "你停下来。你看着自己的手，很久没有动。"],
...
place:"猎场 · 第一只猎物",
req:{mat:"兽皮",n:1},
text:["你带着弓，又去了猎场。那串蹄印已经干了，但老橡树的方向，有什么东西在等你。", "你蹲在树后，屏住呼吸。傍晚，一头灰白色的鹿从林子里走出来，脚步很轻，像踩着雾。", "你拉开弓。弦声在风里绷紧。", "鹿抬起头，看着你的方向。它的眼睛很亮，像两粒琥珀。", "你想起那根扎破你手指的兽毛。你松开弦，箭没有射出去。", "鹿在原地站了一会儿，转身走进林子，没有跑。", "你放下弓。风从林子里吹出来，带着一股潮湿的、草根的味道。你知道，从今天起，这片猎场，认得你了。"],
...
place:"后林 · 溪谷回应",
req:{mat:"精灵林间晶露",n:1},
text:["你又去了溪谷。那棵被你扶正的树苗，长高了一截，叶子绿了大半。", "你蹲下来，摸了摸它的枝干。枝干微微一颤，像在应你。", "你听见溪谷里响起水声——不是溪流，是一条细流，从河床的卵石缝里渗出来，慢慢汇成一线。", "你捧起水喝了一口。水是凉的，带着一丝泥土的甜味。", "你坐在树苗旁边，听那线细流响了一下午。", "傍晚，你站起来，准备离开。树苗的叶子，在风里轻轻摇了摇，像在跟你道别。", "你走出溪谷。回头时，那线细流还在响，细细的，像溪谷在哼一支歌。"],
...
place:"城南 · 矮灯再起",
req:{mat:"铁门关军报",n:1},
text:["你又在城南的麦田边蹲了一夜。那盏矮灯，没有亮。", "你正打算回去，忽然看见那口枯井的井沿上，多了一道新的刮痕。不是旧的——你昨天记过旧痕的位置。", "你走过去，蹲下来看。刮痕旁边，压着一粒干泥。干泥里，裹着一片碎麦秆。", "你捻开干泥。麦秆是南边农庄种的——城南的麦田，今年没有种麦。", "你把干泥收进小包，直起身。远处的钟楼敲了三下。", "你往回走，心里把两条线并在一起：北边来的水手结，南边麦田里的碎麦秆。中间隔着一条，你还没看见的路。", "你决定，明天去农庄看看。"],
...
place:"马厩 · 第一句话",
req:{mat:"兽骨",n:1},
text:["灰猫的腿好了，走路不再拖。它还是睡在草垛上，但每天都等你来喂。", "这天傍晚，你蹲在草垛边，给它梳毛。灰猫眯着眼，忽然开口——不是猫叫，是一个气音，像人压着嗓子说话。", "你屏住呼吸，凑近。它又说了一声，这次清楚了些，像两个字。", "你听不懂，但枣红马在旁边喷了个响鼻，像在笑话你。", "你问灰猫：'你在说什么？'", "灰猫看了你一眼，站起来，用尾巴扫了扫你的手腕，跳下草垛，走进暮色里。", "你站在原地。枣红马又喷了个响鼻，这次，你听懂了——它在说：'它说谢谢。'", "你愣了很久。你分不清那是你听懂的马语，还是你编的。但你笑了。"],
...
place:"宿舍 · 影子练习",
req:{mat:"夜枭羽",n:1},
text:["你开始在影子里练习。不是练影子，是练“不在”。", "你站在墙边，把呼吸放慢，把存在感收起来，像把一盏灯慢慢拧暗。", "第一次，室友推门进来，没有看见你。他在桌上放了本书，又出去了。", "你从墙边走出来，看着那本书。你甚至没有听见自己的脚步声。", "你坐下来，翻开那本书——扉页上写着一行字，是室友的笔迹：'屋里的灯，刚才暗了一下。'", "你合上书。你把那行字看了很久，然后，你把书放回原处，假装什么都没发生。", "你知道，从今晚起，你学会了“不在”的第一课。"],
...
place:"仓库 · 锁孔记忆",
req:{mat:"旧铜锁",n:1},
text:["你回到仓库，那口铜盒还放在杂物间最里面。你把它取出来，放在月光下。", "你转了一下铜盘。这次你没有想打开它——你只是听。铜盘转动的声音，有七个齿，三个松，四个紧。", "你记住这个顺序。咔嗒一声，盒子开了。", "里面还是那把铜钥匙和那张纸条。你没有拿。你合上盖子，让铜盘转回原位，咔嗒，锁住。", "你把它放回原处。走出仓库，你的手指，还在回味那七个齿的松紧。", "你知道，锁不是用来防你的。它只是在等你记住它。"],
...
place:"铁匠铺 · 面具",
req:{mat:"暗蚀会文书",n:1},
text:["你路过城南铁匠铺，老周还坐在门槛上抽烟。他看见你，招了招手。", "你走过去。他递给你一个纸包：'有人托我给你的。'", "你打开。纸包里是一张薄薄的银面具，没有五官，只有两个眼孔。", "'谁给的？'你问。", "老周吐出一口烟：'他没说。只说他认得你。'", "你把面具收进怀里。走出铁匠铺，你摸了一下面具——银面是温的，像刚被人戴过。", "你站在街角，犹豫了一下，没有戴上它。但你把它贴身收好了。"],
...
place:"澡堂 · 第一次换脸",
req:{mat:"无面蜡",n:1},
text:["你站在更衣间的铜镜前，又画了一个圈。", "水汽顺着圈痕流下来。镜面里，你的脸正常地回望着你——但这次，你试着让它变。", "你想着一个你见过的人：食堂那个总是低着头的学徒。", "镜面里的脸，慢慢变了——眉骨低了一点，颧骨平了一点，眼神垂下来。", "你看着那张陌生的脸，心里涌起一阵说不清的感觉。你抬手，镜中人也抬手。", "你退后一步。镜中的脸，慢慢变回你自己的。", "你穿好衣服，走出澡堂。路上，你试着低了一下头——你发现，低头的时候，没有人看你。"],
...
place:"医务室 · 第一次成愈",
req:{mat:"药草",n:1},
text:["医师又让你去换药。这回躺着的，是一个烧伤的学徒，手臂裹着纱布，疼得直抽气。", "你蹲下来，解开纱布。伤口红得发亮，药粉黏在上面。", "你的指尖又开始发凉。你把手覆在伤口上方，让那股凉意流下去。", "学徒的抽气声慢慢停了。他睁开眼，看着你，小声说：'不疼了。'", "医师站在门口，没有说话。你收手的时候，指尖凉得发麻。", "你走出医务室，靠在墙上，喘匀气。", "医师跟出来，递给你一卷白布：'以后，重伤的，都归你。'他没有说谢，但你听懂了。"],
...
place:"教堂 · 第一道圣裁",
req:{mat:"净化令文书",n:1},
text:["你又在告解室外听见了那个声音。这次，只有一个人。", "'……我守不住那个秘密了。'", "你站在门外，没有动。你听见里面的人哭了起来，很轻，像怕被人听见。", "你推开门。告解室里坐着一个年轻人，脸上全是汗。他看见你，愣住了。", "你在他对面坐下，说：'说吧。'", "他把话讲完了——一件他藏在心里三年的错事。你听完，没有评判，只问：'你愿意去把它还回去吗？'", "他点头，像卸下了一副重担。你走出告解室，阳光很亮。你发现，自己心里那个“该不该管”的问题，有了答案。"],
...
place:"武场 · 战牧合一",
req:{mat:"圣徽",n:1},
text:["你在靶场又遇见了那个练箭的女孩。她已经能拉开弓了，箭上了环。", "她看见你，眼睛一亮：'你看！'", "你蹲下来，这次教了她一个不一样的——'握弓的时候，心里想着你要护住的人。'", "她似懂非懂地试了试。箭离弦，钉在靶心。", "她欢呼起来。你看着靶心那支箭，忽然明白了一件事——神术和武技，从来不是两样东西。", "它们都是“护住”这个词的两种写法。", "你走出靶场。晚风里，你的手，一半是握过弓的，一半是握过圣像的。"],
...
place:"苦修室 · 石头回应",
req:{mat:"苦修石",n:1},
text:["你又去苦修室送饭。老修士还跪在那块石头前。", "你放下饭，没有走。你跪在他旁边，一起看着那块石头。", "石头上的裂缝，比上次宽了一点。你盯着那条缝，看了很久。", "你忽然听见一声极轻的响，像石头深处有什么东西翻了个身。", "老修士睁开眼，看着你：'你也听见了？'", "你点头。他又闭上眼：'九年前，我听见第一声的时候，还以为是幻觉。'", "你陪他坐了一炷香。走出苦修室的时候，你发现自己的掌心，也出现了一道细纹，和石头上的裂缝，一样的走向。"],
...
place:"集市 · 第一笔眼光",
req:{mat:"银月商会券",n:1},
text:["你帮老板娘进货回来，她多给了你三枚铜币：'学得快。'", "你拿着铜币，在集市上转了一圈。你在一个卖旧货的摊子前停下来——摊上有一只陶碗，碗沿缺了个口，摊主要价很低。", "你蹲下来，翻过碗底。碗底有一个极小的印记，像某个商会的章。", "你花两枚铜币买下它。摊主乐得直点头。", "你端着碗，找到商会的人。他们看了碗底的印，当场出价二十枚铜币。", "你没有卖。你把碗收进怀里，走回食堂。老板娘看见你怀里的碗，笑了：'眼光练出来了。'", "你回到宿舍，把碗放在桌上。碗沿的缺口，在月光下，像一只半睁的眼睛。"],
...
place:"账房 · 第一本账",
req:{mat:"旧商队账册",n:1},
text:["你开始跟账房先生学认账。他教你的第一课，不是算术，是“看”。", "他指着账本上一笔旧账：'这笔，记的是粮食。你看出什么？'", "你看了半天：'……买价和卖价，差了四成。'", "他点头：'四成里，三成是利，一成是线。那一成，不是粮食。'", "你没有问那一成是什么。但你把那笔账记在了心里。", "晚上你回宿舍，把那笔账默写了一遍。你看着那串数字，忽然觉得，它们像一排脚印——通向一个你还没看清的地方。", "你合上本子。你开始明白，账房先生说的“看”，是看账本背后的人。"],
...
place:"礼堂 · 第一次造势",
req:{mat:"拍卖槌",n:1},
text:["学院又要办拍卖会。这次，你主动接了登记台的活。", "你悄悄做了一件事：把那把流拍的旧匕首，摆在最显眼的角落，旁边放了一盏灯，让刀柄上的精灵文，正好落在光里。", "拍卖开始，果然有人问那把匕首。你报了三次价，让价格翻了五倍。", "成交后，买主是个学者，捧着匕首，像捧着珍宝。", "散场后，学院长路过登记台，看了你一眼：'那把匕首，值那个价吗？'", "你老实说：'不知道。但有人觉得值，它就值。'", "学院长没有接话。他走的时候，脚步比来时慢了半拍。"],
...
place:"码头 · 第一条暗线",
req:{mat:"禁运货单",n:1},
text:["你打听到，那批压着枯叶箱子的货，是从北边一条旧航线运来的。那条航线，三年前就废了。", "你去了码头，找到一艘系在角落的旧船。船夫是个瘦老头，看见你，先开了口：'你找错船了。'", "'我没找船。'你说，'我找那批枯叶。'", "他看了你很久，从舱底摸出一只木箱，箱盖上压着一片干麦秆，和你在井沿看到的一样。", "'你认识？'他问。", "你摇头：'不认识。但我认识压着它的那只手。'", "老头笑了，把木箱推过来：'那你也认识我。'", "你把木箱带回去，没有打开。你把它放在床底下，你知道，从今晚起，你有了第一条线。"],
...
place:"火晶尘 · 仪式之约",
text:["你想起导师在元素课上说过的一句话：“火认人，也认路。你要让火走你的路，得先给火一粒它的尘。”", "风炉间的人说，炉膛里的火晶尘，每月清一次，清出来的细尘都收在炉边的陶罐里。", "那是火自己褪下的皮。用它做引子，火才会记得你的手。"],
options:[{t:"就地寻找火晶尘", go:"sub_elemental_g2"},
{t:"先记下，改日再来", go:"sub_path_hub"}]}};

N["sub_elemental_g2"]=function(){return{
place:"风炉间 · 炉边陶罐",
text:["你掀开炉边的陶罐。罐底积着一层亮晶晶的细尘，在暗处微微泛红。", "你用小勺舀了一撮，装进纸包。指尖隔着纸，还是热的。"],
effect:{mat:"火晶尘",flag:"v489_got_elemental"},
options:[{t:"收好，回去", go:"sub_path_hub"}]}};

N["sub_conjurer_g"]=function(){return{
place:"旧纸人 · 仪式之约",
text:["咒法课的前辈听说你想学召唤，笑了笑：“纸人不难画，难的是让它记住你。”", "“先找个旧纸人——画过很多次、被改过很多次的。它身上有前一个主人的笔意。”", "学院杂物间最里面的旧柜里，据说就压着一叠这样的纸人。"],
options:[{t:"就地寻找旧纸人", go:"sub_conjurer_g2"},
{t:"先记下，改日再来", go:"sub_path_hub"}]}};

N["sub_conjurer_g2"]=function(){return{
place:"学院杂物间 · 旧柜最底",
text:["你翻到柜子最底层，抽出一叠纸人。纸已经泛黄，腿脚处补了三次，笔迹歪歪扭扭。", "你挑了一张最旧的，揣进怀里。纸人贴着胸口，像一张温顺的纸。"],
effect:{mat:"旧纸人",flag:"v489_got_conjurer"},
options:[{t:"收好，回去", go:"sub_path_hub"}]}};

N["sub_arcane_g"]=function(){return{
place:"静默墨 · 仪式之约",
text:["档案馆的旧结界图，落款处有一行小字：“以静默墨写印，结界方成。”", "静默墨是图书馆抄本室才有的东西——干了之后仍会渗墨，蘸它写字，笔尖不响。", "抄写员说，那墨是给抄遗书的人用的。"],
options:[{t:"就地寻找静默墨", go:"sub_arcane_g2"},
{t:"先记下，改日再来", go:"sub_path_hub"}]}};

N["sub_arcane_g2"]=function(){return{
place:"图书馆 · 抄本室墨缸",
text:["你帮抄写员校完一卷旧卷。他指指角落的墨缸：“要写封条？自己舀。”", "你舀了一小瓶。墨色极黑，凑近了，闻不到一点味道。"],
effect:{mat:"静默墨",flag:"v489_got_arcane"},
options:[{t:"收好，回去", go:"sub_path_hub"}]}};

N["sub_necromancer_g"]=function(){return{
place:"骨灰 · 仪式之约",
text:["守望者的老前辈听说你在坟场练银线，没有拦你，只留下一句：“亡者之事，用亡者之物。”", "他说后山老槐树下的土，每年清明会有人去撒一把灰——那是烧给无主孤魂的。", "那灰，就是引子。"],
options:[{t:"就地寻找骨灰", go:"sub_necromancer_g2"},
{t:"先记下，改日再来", go:"sub_path_hub"}]}};

N["sub_necromancer_g2"]=function(){return{
place:"后山坟场 · 老槐树下",
text:["你蹲在老槐树下，拨开枯叶。土里果然混着一层灰白的细灰，散着一股说不清的凉。", "你用陶罐装了一小罐，盖紧。起身时，风绕着你走了一圈。"],
effect:{mat:"骨灰",flag:"v489_got_necromancer"},
options:[{t:"收好，回去", go:"sub_path_hub"}]}};

N["sub_medium_g"]=function(){return{
place:"旧钟绳 · 仪式之约",
text:["钟楼的守钟人是个哑巴，但他会写字。他在你手心写：“听钟的人，先碰过钟绳。”", "顶层那口旧钟的钟绳，换过三次，旧绳都堆在角落。", "绳上缠着一截褪色的红布——是上一任守钟人的记号。"],
options:[{t:"就地寻找旧钟绳", go:"sub_medium_g2"},
{t:"先记下，改日再来", go:"sub_path_hub"}]}};

N["sub_medium_g2"]=function(){return{
place:"钟楼顶层 · 旧绳堆",
text:["你爬上顶层，在旧绳堆里翻出一截最旧的。绳股磨得发亮，像被握了一辈子。", "你把红布那一截剪下来，收进口袋。楼下，钟正好敲了一下。"],
effect:{mat:"旧钟绳",flag:"v489_got_medium"},
options:[{t:"收好，回去", go:"sub_path_hub"}]}};

N["sub_hypnotist_g"]=function(){return{
place:"烛泪 · 仪式之约",
text:["医师教你的第一课不是火，是蜡：“火苗可以骗，烛泪骗不了。你看一支蜡烛烧到第几夜，就知道它有没有心事。”", "教堂清晨收烛台时，会刮下隔夜的烛泪。那泪里，凝着前一晚所有祈祷的重量。", "用隔夜的烛泪点新火，火会记得前一夜。"],
options:[{t:"就地寻找烛泪", go:"sub_hypnotist_g2"},
{t:"先记下，改日再来", go:"sub_path_hub"}]}};

N["sub_hypnotist_g2"]=function(){return{
place:"教堂 · 清晨烛台",
text:["你清晨第一个进教堂，收烛台时，把凝在烛台边的白蜡泪刮进小瓶。", "蜡泪凉了，但指尖留下一丝焦甜。你盖好瓶塞。"],
effect:{mat:"烛泪",flag:"v489_got_hypnotist"},
options:[{t:"收好，回去", go:"sub_path_hub"}]}};

N["sub_soulbinder_g"]=function(){return{
place:"契约纸 · 仪式之约",
text:["缚魂者的传承里有一句老话：“约，要写在能烧的纸上。烧了，才算数。”", "城西文书铺的契约纸，是羊皮做的，边角压着火漆。文书匠说，那纸经得起改写。", "你需要的，是一张空白的、还没被写过的契约纸。"],
options:[{t:"就地寻找契约纸", go:"sub_soulbinder_g2"},
{t:"先记下，改日再来", go:"sub_path_hub"}]}};

N["sub_soulbinder_g2"]=function(){return{
place:"城西 · 文书铺",
text:["文书匠正打瞌睡。你放了两枚铜币在柜上，抽走一页裁好的羊皮纸。", "他眼皮也没抬：“要写契？找对人了。”"],
effect:{mat:"契约纸",flag:"v489_got_soulbinder"},
options:[{t:"收好，回去", go:"sub_path_hub"}]}};

N["sub_alchemist_g"]=function(){return{
place:"银液 · 仪式之约",
text:["你坩埚里那瓶用不完的银液，其实不是你的——炼金同业会的人说，那是“初液”，每一炉都从它分出来。", "真正的银液，只认蒸馏台。谁在台上守满三炉，它才认谁。", "你自己的那瓶，就是。"],
options:[{t:"就地寻找银液", go:"sub_alchemist_g2"},
{t:"先记下，改日再来", go:"sub_path_hub"}]}};

N["sub_alchemist_g2"]=function(){return{
place:"术士工坊 · 蒸馏台",
text:["你回到自己的蒸馏台，那瓶银液还搁在老位置，瓶口悬着一滴，不落。", "你把它装进新瓶，贴好标签。银液在瓶里轻轻晃了晃，像应了你一声。"],
effect:{mat:"银液",flag:"v489_got_alchemist"},
options:[{t:"收好，回去", go:"sub_path_hub"}]}};

N["sub_forger_g"]=function(){return{
place:"精铁块 · 仪式之约",
text:["老铁匠看了一眼你的铁环：“火认了你，铁还没认。”", "“铁认人，靠的是精铁——千锤百炼、没夹过渣的。公会铁匠铺里有，修好霍根的锻锤，他会给你一块。”", "精铁块是铁的骨头。用它做引，铁才会听你的话。"],
options:[{t:"就地寻找精铁块", go:"sub_forger_g2"},
{t:"先记下，改日再来", go:"sub_path_hub"}]}};

N["sub_forger_g2"]=function(){return{
place:"自由城邦 · 公会铁匠铺",
text:["你帮霍根修好那柄断了柄的锻锤。他掂了掂，从炉边摸出一块沉甸甸的精铁，抛给你。", "铁块还带着炉火的余温。你握在手里，像握着一小块凝固的太阳。"],
effect:{mat:"精铁块",flag:"v489_got_forger"},
options:[{t:"收好，回去", go:"sub_path_hub"}]}};

N["sub_machinist_g"]=function(){return{
place:"黄铜齿轮 · 仪式之约",
text:["机械鸟啄了啄你的图纸，又啄了啄桌角——那有个凹痕，正好是齿轮的形状。", "你懂了：它要一枚齿轮。东境工坊的废料箱里，这样的齿轮多得是。", "旧的齿轮最好，齿缝里嵌着上一个造物主的黑油。"],
options:[{t:"就地寻找黄铜齿轮", go:"sub_machinist_g2"},
{t:"先记下，改日再来", go:"sub_path_hub"}]}};

N["sub_machinist_g2"]=function(){return{
place:"东境工坊 · 废料箱",
text:["你在废料箱里翻出一枚黄铜齿轮，齿缝里嵌着黑油，转起来咔咔响。", "你擦干净，装进口袋。机械鸟歪着头，看着你的口袋，像在点数。"],
effect:{mat:"黄铜齿轮",flag:"v489_got_machinist"},
options:[{t:"收好，回去", go:"sub_path_hub"}]}};

N["sub_bloodsorcerer_g"]=function(){return{
place:"兽血 · 仪式之约",
text:["你掌心的暗红色线，这几天又深了一点。你问医师，他摇头：“这不是病。”", "猎场的老猎户说，血脉的事，要用兽血应——不是杀生，是取一头自愿的兽的血。", "猎场屠宰棚里，每天都有猎户分好的小皮囊。"],
options:[{t:"就地寻找兽血", go:"sub_bloodsorcerer_g2"},
{t:"先记下，改日再来", go:"sub_path_hub"}]}};

N["sub_bloodsorcerer_g2"]=function(){return{
place:"猎场 · 屠宰棚",
text:["你帮猎户剥了一下午皮。收工时，他塞给你一小皮囊：“温的，趁热用。”", "皮囊隔着一层皮，还是温的。你把它贴身收好。"],
effect:{mat:"兽血",flag:"v489_got_bloodsorcerer"},
options:[{t:"收好，回去", go:"sub_path_hub"}]}};

N["sub_berserker_g"]=function(){return{
place:"狂兽之牙 · 仪式之约",
text:["教官听说你想走狂战士的路，沉默了一会儿：“怒意是兽。驯兽，要先有兽的东西。”", "“狂兽之牙——草原上发狂的兽，牙根带着血。拿它当引，你的怒意才知道谁说了算。”", "猎场深处，偶尔能捡到这样的牙。"],
options:[{t:"就地寻找狂兽之牙", go:"sub_berserker_g2"},
{t:"先记下，改日再来", go:"sub_path_hub"}]}};

N["sub_berserker_g2"]=function(){return{
place:"猎场深处 · 枯树下",
text:["你在猎场深处一棵枯树下，捡到一根獠牙。牙根干着血，沉得不像牙。", "你把它收进怀里。握着它，你心里那头兽，安静了一下。"],
effect:{mat:"狂兽之牙",flag:"v489_got_berserker"},
options:[{t:"收好，回去", go:"sub_path_hub"}]}};

N["sub_weaponmaster_g"]=function(){return{
place:"旧剑刃 · 仪式之约",
text:["武库看守说，你摸剑的手感是天生的，但还差一味：“旧剑刃。”", "“断过的剑，刃口还留着一点寒光。那点寒光里，是前一任剑主的握法。”", "武库报废架上，这样的断剑有一堆。"],
options:[{t:"就地寻找旧剑刃", go:"sub_weaponmaster_g2"},
{t:"先记下，改日再来", go:"sub_path_hub"}]}};

N["sub_weaponmaster_g2"]=function(){return{
place:"武库 · 报废架",
text:["你在报废架上抽出一柄断剑。剑身锈了，但刃口还有一点寒光。", "你握着它，试着找那个发力点——找到了。你的手，比刚才更稳了。"],
effect:{mat:"旧剑刃",flag:"v489_got_weaponmaster"},
options:[{t:"收好，回去", go:"sub_path_hub"}]}};

N["sub_shieldguard_g"]=function(){return{
place:"铁钉 · 仪式之约",
text:["箭楼哨兵听你说要学盾阵，点点头：“盾不是铁打的，是钉子钉的。”", "“一块盾要经得住，全靠每颗钉子都咬住木头。找一枚旧铁钉——弯过又直回来的那种。”", "铁匠铺的废渣堆里，这样的钉子多得是。"],
options:[{t:"就地寻找铁钉", go:"sub_shieldguard_g2"},
{t:"先记下，改日再来", go:"sub_path_hub"}]}};

N["sub_shieldguard_g2"]=function(){return{
place:"铁匠铺 · 废渣堆",
text:["你在废渣堆里翻出一枚铁钉，钉帽上有一道旧捶痕，弯过又直了回来。", "你把它收进口袋。夜里，你把它放在枕边，硌着，像在提醒你什么。"],
effect:{mat:"铁钉",flag:"v489_got_shieldguard"},
options:[{t:"收好，回去", go:"sub_path_hub"}]}};

N["sub_warlord_g"]=function(){return{
place:"旧军旗 · 仪式之约",
text:["军略课教官带你去军需库，指着一面旧旗：“为将者，先学会认旗。”", "“旧旗上烧过的洞，是它替你挡过的祸。拿一截旧旗做引，你的阵，才记得自己是谁的阵。”", "军需库的旧物资里，收着历年换下来的旗。"],
options:[{t:"就地寻找旧军旗", go:"sub_warlord_g2"},
{t:"先记下，改日再来", go:"sub_path_hub"}]}};

N["sub_warlord_g2"]=function(){return{
place:"学院军需库",
text:["你替军需官整理旧物资，从箱底抽出一面旧旗。旗边烧了一个洞，洞沿是焦的。", "你剪下一小条，叠好收进怀里。军需官看见了，没说话，只点了点头。"],
effect:{mat:"旧军旗",flag:"v489_got_warlord"},
options:[{t:"收好，回去", go:"sub_path_hub"}]}};

N["sub_paladin_g"]=function(){return{
place:"圣城长明灯芯 · 仪式之约",
text:["老修士教你的不是祷告，是灯：“圣辉不灭，是因为有人添油。”", "“圣城长明灯烧了三百年的灯芯，是圣辉的根。你要立誓，先借一段根。”", "圣城教堂的圣坛，长明灯从不断。灯芯每年换一次，换下来的都收在圣物柜。"],
options:[{t:"就地寻找圣城长明灯芯", go:"sub_paladin_g2"},
{t:"先记下，改日再来", go:"sub_path_hub"}]}};

N["sub_paladin_g2"]=function(){return{
place:"圣城 · 圣坛灯芯",
text:["你跪在圣坛前，向守灯修士求一段换下来的旧灯芯。他看了你很久，剪下一小段，放在你掌心。", "灯芯是温的，像烧了三百年的余温，还留在上面。"],
effect:{mat:"圣城长明灯芯",flag:"v489_got_paladin"},
options:[{t:"收好，回去", go:"sub_path_hub"}]}};

N["sub_protector_g"]=function(){return{
place:"圣水 · 仪式之约",
text:["侧廊的老妇教会你一件事：护着别人，自己先要立得住。", "立得住的法子，在圣水里——清晨弥撒前取一小瓶，沾在额上，心里那面盾才不会锈。", "教堂圣坛的铜瓶里，盛着隔夜的圣水。"],
options:[{t:"就地寻找圣水", go:"sub_protector_g2"},
{t:"先记下，改日再来", go:"sub_path_hub"}]}};

N["sub_protector_g2"]=function(){return{
place:"教堂 · 圣坛铜瓶",
text:["你清晨第一个到教堂，从圣坛铜瓶里倒了一小瓶圣水。", "水隔着瓶壁，凉得透心。你握了一会儿，掌心慢慢热起来。"],
effect:{mat:"圣水",flag:"v489_got_protector"},
options:[{t:"收好，回去", go:"sub_path_hub"}]}};

N["sub_itinerant_g"]=function(){return{
place:"驿道图 · 仪式之约",
text:["驿丞听说你要走四方，从旧图柜里抽出一张图：“巡游的人，先认路。”", "“这张图是废的——上面的路标，三年没更新了。可它记着所有走错过的路。”", "走错过的路，比走对的路，更值得记。"],
options:[{t:"就地寻找驿道图", go:"sub_itinerant_g2"},
{t:"先记下，改日再来", go:"sub_path_hub"}]}};

N["sub_itinerant_g2"]=function(){return{
place:"驿站 · 旧图柜",
text:["驿丞把那张废图推给你。墨线被雨水洇过，像蛛网。", "你折好收进怀里。走出驿站，你忽然觉得，这张图在教你看路的另一种方法。"],
effect:{mat:"驿道图",flag:"v489_got_itinerant"},
options:[{t:"收好，回去", go:"sub_path_hub"}]}};

N["sub_darkknight_g"]=function(){return{
place:"黑曜石刀片 · 仪式之约",
text:["地牢深处的歌声，你又听见了一次。这次，你听清了一句：“黑曜石认得夜里的人。”", "黑曜石刀片，沙漠深处的石头打磨成的。锋利得能划开月光，也划得开旧誓。", "废矿的尽头，有人埋过一片。"],
options:[{t:"就地寻找黑曜石刀片", go:"sub_darkknight_g2"},
{t:"先记下，改日再来", go:"sub_path_hub"}]}};

N["sub_darkknight_g2"]=function(){return{
place:"死亡沙漠 · 废矿尽头",
text:["你在废矿尽头，从碎石堆里刨出一片黑曜石刀片。刃口冰凉，像刚从月光里捞出来。", "你把它收进怀里。口袋里的钥匙，轻轻响了一下，像应了它。"],
effect:{mat:"黑曜石刀片",flag:"v489_got_darkknight"},
options:[{t:"收好，回去", go:"sub_path_hub"}]}};

N["sub_hunter_g"]=function(){return{
place:"兽皮 · 仪式之约",
text:["猎场看守听你说要学追猎，指指墙上的兽皮：“猎人的手，先认皮。”", "“兽皮是兽的一生。硝过的硬皮，摸得出它跑过哪些地方。”", "猎场晒皮架上，晾着新硝的兽皮。"],
options:[{t:"就地寻找兽皮", go:"sub_hunter_g2"},
{t:"先记下，改日再来", go:"sub_path_hub"}]}};

N["sub_hunter_g2"]=function(){return{
place:"猎场 · 晒皮架",
text:["你从晒皮架上取下一小块边角料，皮面硝得发硬，纹路粗粝。", "你把它揣进怀里。手指划过皮面时，像划过一片跑过很远的地方。"],
effect:{mat:"兽皮",flag:"v489_got_hunter"},
options:[{t:"收好，回去", go:"sub_path_hub"}]}};

N["sub_warden_g"]=function(){return{
place:"精灵林间晶露 · 仪式之约",
text:["巡林者前辈教你看树：“树不说谎。你要守一片林，先喝一口林的记忆。”", "精灵林间的晶露，是精灵收集百年的晨露。喝下它，能看见森林的记忆。", "银叶城边缘的杉树林，黎明前最浓。"],
options:[{t:"就地寻找精灵林间晶露", go:"sub_warden_g2"},
{t:"先记下，改日再来", go:"sub_path_hub"}]}};

N["sub_warden_g2"]=function(){return{
place:"银叶城 · 杉树林黎明",
text:["你在黎明前走进杉树林，用晶瓶接了一瓶晨露。露水凝在叶尖，像碎了一地的月光。", "你封好晶瓶。瓶里的露水，在暗处微微发光。"],
effect:{mat:"精灵林间晶露",flag:"v489_got_warden"},
options:[{t:"收好，回去", go:"sub_path_hub"}]}};

N["sub_scout_g"]=function(){return{
place:"铁门关军报 · 仪式之约",
text:["哨兵长教你看风向，也教你看纸：“北边的军报，一个月来三封。”", "“你需要的，是那封写着『无战事』、页角墨迹却是新的——有人不想让战事被人知道。”", "驿站的信筒里，这样的军报，偶尔会混进来。"],
options:[{t:"就地寻找铁门关军报", go:"sub_scout_g2"},
{t:"先记下，改日再来", go:"sub_path_hub"}]}};

N["sub_scout_g2"]=function(){return{
place:"驿站 · 信筒",
text:["你帮驿丞分信，从信筒里抽出一封角墨尚新的军报。上面写着『无战事』，墨迹却是新的。", "你记下内容，把信放回原处。走出驿站，你心里那条线，又清晰了一寸。"],
effect:{mat:"铁门关军报",flag:"v489_got_scout"},
options:[{t:"收好，回去", go:"sub_path_hub"}]}};

N["sub_beastfriend_g"]=function(){return{
place:"兽骨 · 仪式之约",
text:["灰猫带你去溪谷，蹲在一节兽骨前，不走。", "你懂了：兽语者要学兽的言语，先有一件兽的东西。", "溪谷里的兽骨，被水冲得光洁，风一吹会响——那是兽留给风的语言。"],
options:[{t:"就地寻找兽骨", go:"sub_beastfriend_g2"},
{t:"先记下，改日再来", go:"sub_path_hub"}]}};

N["sub_beastfriend_g2"]=function(){return{
place:"猎场边缘 · 溪谷",
text:["你捡起那节兽骨。骨面光滑，风穿过骨孔，发出一声细细的哨音。", "你把它系在腰上。灰猫蹭了蹭你的腿，像是满意了。"],
effect:{mat:"兽骨",flag:"v489_got_beastfriend"},
options:[{t:"收好，回去", go:"sub_path_hub"}]}};

N["sub_assassin_g"]=function(){return{
place:"夜枭羽 · 仪式之约",
text:["你练“不在”练到第三夜，窗台上落了一根漆黑的羽毛。", "不是鸟掉的——是夜枭自己拔下来，放在那里的。夜枭是夜里的猎手，它认得同类。", "钟楼顶的夜枭，每夜都在那里。它偶尔会留下这样的信物。"],
options:[{t:"就地寻找夜枭羽", go:"sub_assassin_g2"},
{t:"先记下，改日再来", go:"sub_path_hub"}]}};

N["sub_assassin_g2"]=function(){return{
place:"钟楼顶 · 夜",
text:["你在钟楼顶守到半夜。那只夜枭蹲在檐角，看着你。", "你伸出手。它偏了偏头，把一根羽毛放在你掌心，展翅飞走了。"],
effect:{mat:"夜枭羽",flag:"v489_got_assassin"},
options:[{t:"收好，回去", go:"sub_path_hub"}]}};

N["sub_burglar_g"]=function(){return{
place:"旧铜锁 · 仪式之约",
text:["你回味着铜盒那七个齿的松紧，手痒得厉害。", "城西杂货摊的摊主说：“锁匠的手，是旧锁喂出来的。找一把钥匙丢了的旧锁，慢慢听。”", "旧货摊上，这样的铜锁摆了一排。"],
options:[{t:"就地寻找旧铜锁", go:"sub_burglar_g2"},
{t:"先记下，改日再来", go:"sub_path_hub"}]}};

N["sub_burglar_g2"]=function(){return{
place:"城西 · 杂货摊",
text:["你花几枚铜币，从旧货摊上买了一把没钥匙的旧铜锁。锁芯磨得发亮。", "你把它握在手心，听着锁舌轻轻咬合的声音，像听一个老朋友说话。"],
effect:{mat:"旧铜锁",flag:"v489_got_burglar"},
options:[{t:"收好，回去", go:"sub_path_hub"}]}};

N["sub_spy_g"]=function(){return{
place:"暗蚀会文书 · 仪式之约",
text:["你顺着那条线，摸到了一点暗蚀会的东西。", "档案室主任的账册、城南铁匠铺的纸条——这些线索的源头，都指向一种文书。", "暗蚀会文书，字迹工整，落款只有一个倒悬的钟。地下世界里，这东西能换一条命。"],
options:[{t:"就地寻找暗蚀会文书", go:"sub_spy_g2"},
{t:"先记下，改日再来", go:"sub_path_hub"}]}};

N["sub_spy_g2"]=function(){return{
place:"城北湿地 · 旧窖",
text:["你在城北湿地边的旧窖里，找到一封暗蚀会文书。字迹工整，落款是倒悬的钟。", "你记下内容，把文书放回原处。走出旧窖，你的手很稳。"],
effect:{mat:"暗蚀会文书",flag:"v489_got_spy"},
options:[{t:"收好，回去", go:"sub_path_hub"}]}};

N["sub_faceless_g"]=function(){return{
place:"无面蜡 · 仪式之约",
text:["你看着镜子里自己的脸，忽然想：这张脸，是不是也可以不是你的？", "面具匠说，无面蜡能塑成任何形状，就是捏不成一张脸——因为捏蜡的手，就是脸的主人。", "澡堂更衣间的梳妆台角落，刮着这样的蜡。"],
options:[{t:"就地寻找无面蜡", go:"sub_faceless_g2"},
{t:"先记下，改日再来", go:"sub_path_hub"}]}};

N["sub_faceless_g2"]=function(){return{
place:"澡堂 · 梳妆台角落",
text:["你在梳妆台角落刮下一小团无面蜡。没有颜色，捏着能塑成任何形状。", "你把它包好收进口袋。走出澡堂时，你发现自己走路的方式，变了半拍。"],
effect:{mat:"无面蜡",flag:"v489_got_faceless"},
options:[{t:"收好，回去", go:"sub_path_hub"}]}};

N["sub_healer_g"]=function(){return{
place:"药草 · 仪式之约",
text:["医师教你认药：“药不是治伤的，是让伤自己的人，愿意好起来。”", "后山向阳坡上的药草，叶背泛白，揉碎了有股醒脑的苦。", "用它当引，你的手才知道，该把那股凉意往哪里送。"],
options:[{t:"就地寻找药草", go:"sub_healer_g2"},
{t:"先记下，改日再来", go:"sub_path_hub"}]}};

N["sub_healer_g2"]=function(){return{
place:"学院后山 · 向阳坡",
text:["你课后去后山，在向阳坡上采了一束药草。叶背泛白，揉碎了有股醒脑的苦。", "你把它晾在医务室窗台上。医师路过，看了一眼，没说话。"],
effect:{mat:"药草",flag:"v489_got_healer"},
options:[{t:"收好，回去", go:"sub_path_hub"}]}};

N["sub_inquisitor_g"]=function(){return{
place:"净化令文书 · 仪式之约",
text:["告解室那件事之后，你开始查教会里的旧文书。", "净化令文书——盖着圣痕司火漆的教令，措辞庄严，字里行间却透着焦味。", "教会档案室的旧卷柜里，压着历年收回的净化令。"],
options:[{t:"就地寻找净化令文书", go:"sub_inquisitor_g2"},
{t:"先记下，改日再来", go:"sub_path_hub"}]}};

N["sub_inquisitor_g2"]=function(){return{
place:"教会档案室 · 旧卷柜",
text:["你替档案室整理旧卷，从柜底抽出一封旧净化令。火漆还在，焦味还在。", "你读了那行措辞庄严的字，心里那个问题，又沉了一点。"],
effect:{mat:"净化令文书",flag:"v489_got_inquisitor"},
options:[{t:"收好，回去", go:"sub_path_hub"}]}};

N["sub_warpriest_g"]=function(){return{
place:"圣徽 · 仪式之约",
text:["靶场女孩问你的那个问题——“你教我的，算不算神术？”——你一直没有答案。", "圣徽是答案的一半：一枚磨得发亮的铜徽，正面刻着太阳。", "教会圣物柜里收着历年替换下来的旧圣徽。"],
options:[{t:"就地寻找圣徽", go:"sub_warpriest_g2"},
{t:"先记下，改日再来", go:"sub_path_hub"}]}};

N["sub_warpriest_g2"]=function(){return{
place:"教堂 · 圣物柜",
text:["你替教会整理圣物，从柜底请出一枚旧圣徽。铜面磨得发亮，背面刻着一行小字。", "你把它挂在颈上。圣徽贴着胸口，凉了一下，又热起来。"],
effect:{mat:"圣徽",flag:"v489_got_warpriest"},
options:[{t:"收好，回去", go:"sub_path_hub"}]}};

N["sub_ascetic_g"]=function(){return{
place:"苦修石 · 仪式之约",
text:["老修士说，那块石头他跪了九年。你问他为什么，他答：“因为它不回答。”", "苦修者需要的，是一块不回答的石头——河滩上拣一块顺手的，够沉，够冷。", "不用找特别的。哪块石头都不回答。"],
options:[{t:"就地寻找苦修石", go:"sub_ascetic_g2"},
{t:"先记下，改日再来", go:"sub_path_hub"}]}};

N["sub_ascetic_g2"]=function(){return{
place:"河滩 · 卵石堆",
text:["你在河滩上拣了一块灰石头，够沉，够冷，掌心刚好握得住。", "你把它带回宿舍，放在枕边。夜里，你握了它一会儿——它果然没有回答。"],
effect:{mat:"苦修石",flag:"v489_got_ascetic"},
options:[{t:"收好，回去", go:"sub_path_hub"}]}};

N["sub_merchant_g"]=function(){return{
place:"银月商会券 · 仪式之约",
text:["老板娘教你的第一课，是看。你看懂了陶碗的章，但她还有一课没教：", "“看懂了东西，还要看得懂纸。银月商会的券，一张纸，撬得动整条商路。”", "南方城邦的银月商会，发的券在商人手里比金币还硬。"],
options:[{t:"就地寻找银月商会券", go:"sub_merchant_g2"},
{t:"先记下，改日再来", go:"sub_path_hub"}]}};

N["sub_merchant_g2"]=function(){return{
place:"南方城邦 · 银月商会",
text:["你替银月商会跑了一趟腿，掌柜随手塞给你一张券：“拿着，路上用得着。”", "纸券轻飘飘的，却能换十枚金龙。你把它贴身收好。"],
effect:{mat:"银月商会券",flag:"v489_got_merchant"},
options:[{t:"收好，回去", go:"sub_path_hub"}]}};

N["sub_banker_g"]=function(){return{
place:"旧商队账册 · 仪式之约",
text:["账房先生看了你默写的旧账，沉默了很久：“你看见了那一成。”", "“那一成不是粮食，是线。你要学金融，先要一本旧账——记着线的那种。”", "南方商路的旧商队账册，最后一页被撕去了，只剩渗血的指印。"],
options:[{t:"就地寻找旧商队账册", go:"sub_banker_g2"},
{t:"先记下，改日再来", go:"sub_path_hub"}]}};

N["sub_banker_g2"]=function(){return{
place:"南方城邦 · 旧货仓",
text:["你在旧货仓的箱底翻出一本旧商队账册。最后一页被撕去了，只剩渗血的指印。", "你把它带回宿舍，在灯下读了一夜。账本里的人，一个个活了过来。"],
effect:{mat:"旧商队账册",flag:"v489_got_banker"},
options:[{t:"收好，回去", go:"sub_path_hub"}]}};

N["sub_auctioneer_g"]=function(){return{
place:"拍卖槌 · 仪式之约",
text:["学院长看了你那天的拍卖，留了一句话：“造势的人，先有槌。”", "拍卖槌敲下去，是给全场一个声音：这一声之后，价就是价。", "学院礼堂的拍卖台，收着一柄旧木槌，槌头磕出了毛边。"],
options:[{t:"就地寻找拍卖槌", go:"sub_auctioneer_g2"},
{t:"先记下，改日再来", go:"sub_path_hub"}]}};

N["sub_auctioneer_g2"]=function(){return{
place:"学院礼堂 · 拍卖台",
text:["你替拍卖会收场，把那柄小木槌拿在手里掂了掂。槌头磕出了毛边，声音又脆又闷。", "你把它放回台上。走出礼堂时，你心里默默敲了一下——那一声，很稳。"],
effect:{mat:"拍卖槌",flag:"v489_got_auctioneer"},
options:[{t:"收好，回去", go:"sub_path_hub"}]}};

N["sub_smuggler_g"]=function(){return{
place:"禁运货单 · 仪式之约",
text:["船夫老头看过你带来的木箱，什么也没问，只推过一张油渍斑斑的货单。", "“货名被划了三道，底下写着另一种货名——这就是走暗线的规矩。”", "码头旧货舱的箱底，压着历年换下来的货单。"],
options:[{t:"就地寻找禁运货单", go:"sub_smuggler_g2"},
{t:"先记下，改日再来", go:"sub_path_hub"}]}};

N["sub_smuggler_g2"]=function(){return{
place:"码头 · 旧货舱",
text:["你在旧货舱箱底翻出一张货单。货名被划了三道，底下写着另一种货名。", "你把它夹进自己那本小册子里。走出码头，海风很咸。"],
effect:{mat:"禁运货单",flag:"v489_got_smuggler"},
options:[{t:"收好，回去", go:"sub_path_hub"}]}};

/*v489inj:abysshit*/
N["abyss_mage_g"]=function(){return{
place:"深渊封印石 · 深渊低语",
...
N["abyss_merch_g2"]=function(){return{
place:"地下市场 · 暗格",
...
"铁匣打开，里面铺着黑绒，几件东西码得整整齐齐，每一件旁边都立着一张倒扣的纸牌。",
],
options:[
...
"她身后的货架上，瓶瓶罐罐没有标签。她随手一指：“想要哪样，拿你身上的一样来换。”",
],
options:[
...
/*v489inj:hub*/
N["sub_path_hub"]=function(){return{
place:"记忆的回廊",
text:[
"灯影摇了一下。",
      ...
      try{
        ...
        if(end>=ctx.txt.length){
          ...
          if(ctx.node&&ctx.node.auto){
            var a=ctx.node.auto;
            setTimeout(function(){ if(a.go){curNode=a.go; writeNext();} }, a.delay||900);
...
N["seal4_heart_whisper"]=function(){
return {
  place:"深渊边缘·心跳",
  text:[
...
N["travel_north_campfire"]=function(){
return {
  place:"北行路上·营地",
  text:[
...
N["seal5_exp_underwater"]=function(){
return {
  place:"深海·下潜",
  text:[
...
N["ending_after_watcher"]=function(){
return {
  place:"多年以后·守望者塔",
  text:[
...
N["seal3_act3_wait_ruins"]=function(){
return {
  place:"银叶森林·废墟等待",
  text:[
...
N["travel_elf_treesong"]=function(){
return {
  place:"精灵林道·树歌",
  text:[
...
N["ending_elder_memoir"]=function(){
return {
  place:"守望者塔·老人回忆",
  text:[
...
function writeNext(_v46f){
  ...
  ChunkLoader.ensureNodeLoaded(curNode, function(){
    ...
    if(!node){ writePar("【此处剧情尚未展开。存档编号："+curNode+"】","noind flagline"); renderPerf.record(Date.now()-_wnT0); return; }
    ...
    var _txt = typeof node.text==="function" ? node.text() : node.text;
    ...
    if(node.auto){ // 自动跳转
      const a = node.auto;
      setTimeout(()=>{ if(a.go){curNode=a.go; writeNext();} }, a.delay||900);
      renderPerf.record(Date.now()-_wnT0);
      return;
    }
    showOptions(node);
...
function choose(opt){
  ...
  if(opt.check){
    ...
    if(opt.mats){ try{ var _mk, _mm=opt.mats, _need=[]; for(_mk in _mm){ if(!S.mats[_mk]||S.mats[_mk]<_mm[_mk]) _need.push(_mk+"×"+(_mm[_mk]-(S.mats[_mk]||0))); } if(_need.length){ if(window.flashMsg) try{ flashMsg("还缺"+_need.join("、")+"……"); }catch(e){} return; } }catch(e){} }
  ...
  renderTop(); renderStats();
  if(S.hp<=0 && !S.ending){ handleDeath(); return; }
  if(S.san<=0 && !S.ending){ showEnding("madness"); return; }
...
function renderLog(){
  let h="";
  for(const l of logs.slice(0,80)) h += "<div class='"+ (l.cls||"") +"'>"+esc(l.m)+"</div>";
  $("log").innerHTML=h;
}
...
function showEnding(id){
  ...
  b.onclick = ()=>{ if(askConfirm("开启一段新的旅程？当前结局将被覆盖。")) newGame(); };
  $("options").appendChild(b);
}
...
/*==v47inj:prelude==*/
N["ending_prelude_hub"]=function(){return{
  ...
  text:function(){
    ...
    if(S.arcProgress && S.arcProgress.faction>=3) lines.push("大陆的势力，因你的奔走，终于把目光，落在了同一处。");
...
/* ============ 通用到达节点 ============ */
N["arrive_generic"] = {
  place:"未知之地", text:["风尘仆仆。你踏上了这片土地。","远处有炊烟，近处有狗吠。世界照常运转，并不为你的到来多停一秒。"],
  options:[
...
N["act_rest"] = {
  place:"落脚处", text:["你找了个便宜的客栈。跳蚤在褥子里蹦跳，隔壁传来鼾声与梦话。","睡一觉。明日的事，明日再说。"],
  options:[
...
function newGame(){
  if(!askConfirm("确定开始新的旅程？当前进度将被覆盖。")) return;
  S = emptyState();
  curNode=null;
  showCreation();
}
...
function openCitySpots(id){
  ...
  if(spots){
    ...
    for(const s of spots){
      h += "<button class='opt' onclick='closeModal(); writePar(\"你走向 "+s+"。\\n\\n\"); mechSecret()'>"+
...
function togglePanel(name){
  const P=$("panels");
  if(curPanel===name){ P.classList.remove("show"); curPanel=null; return; }
  curPanel=name;
  P.classList.add("show");
  // v30: 为侧边栏面板添加统一关闭按钮
  const panelNames = {map:"世界地图", pack:"行囊", realm:"修炼", log:"冒险日志"};
  const title = panelNames[name] || name;
  let closeBar = "<div style='display:flex;justify-content:space-between;align-items:center;padding:6px 4px;border-bottom:1px solid var(--border);margin-bottom:8px'>";
  closeBar += "<span style='color:var(--text-gold);font-weight:bold;font-size:14px'>"+title+"</span>";
  closeBar += "<button onclick='togglePanel(\""+name+"\")' style='background:none;border:1px solid var(--border);border-radius:4px;color:var(--text-secondary);width:26px;height:26px;cursor:pointer;font-size:14px;display:flex;align-items:center;justify-content:center' onmouseover='this.style.color=\"var(--danger)\";this.style.borderColor=\"var(--danger)\"' onmouseout='this.style.color=\"var(--text-secondary)\";this.style.borderColor=\"var(--border)\"'>✕</button>";
  closeBar += "</div>";
  if(name==="map"){ renderMapPanel(); }
  if(name==="pack"){ renderPack(); }
  if(name==="realm"){ renderRealm(); }
  if(name==="log"){ renderLog(); }
  // 在面板内容前插入关闭按钮
  const target = $(name);
  if(target && target.innerHTML.indexOf('panel-close-bar') < 0){
    target.innerHTML = "<div class='panel-close-bar'>" + closeBar + "</div>" + target.innerHTML;
  }
}
function renderPack(){
  let h="<h3>行囊</h3>";
  h+="<div class='row'><span>金币</span><b>"+money(S.gold)+"</b></div>";
  h+="<div class='mini'>道具："+(S.items.length?S.items.map(x=>"%%"+x+"%%").join("、"):"无")+"</div>";
  const mats = Object.keys(S.mats).filter(k=>S.mats[k]>0);
  h+="<div class='mini'>材料："+(mats.length?mats.map(k=>"%%"+k+"%%×"+S.mats[k]).join("、"):"无")+"</div>";
  const books = Object.keys(S.books);
  h+="<div class='mini'>典籍："+(books.length?books.join("、"):"无")+"</div>";
  h+="<h3>游历足迹</h3>";
  const vis = Object.keys(S.visited).filter(k=>k.includes("_"));
  h+="<div class='mini'>"+(vis.length?vis.map(v=>{const[r,c]=v.split("_");return REGIONS[r]?REGIONS[r].cities[c]?REGIONS[r].cities[c].cn:REGIONS[r].cn:"";}).filter(Boolean).join("、"):"尚未远行")+"</div>";
...
function renderRealm(){
  let h="<h3>修炼</h3>";
  if(!S.job){ $("realm").innerHTML=h+"<div class='mini'>尚未选择职业。</div>"; return; }
  h += realmCondList();
...
function godFavorOpen(){
  ...
  if(lvl==="crit"||lvl==="extreme"||lvl==="hard"||lvl==="normal"){
    ...
    writePar("你慌忙掐灭香火，冷汗涔涔。这一问，引来了不该引来的目光。","risky");
...
function init(){
  loadLLMConfig();
  $("btn-map").onclick=()=>togglePanel("map");
  ...
  storyEl = $("story");
  const saved = localStorage.getItem(RULESET_ID+"-save");
  if(saved){
    try{
      const d=JSON.parse(saved);
      if(d.ruleset===RULESET_ID && !d.ending){
        if(askConfirm("检测到存档（第"+d.day+"日，"+d.name+"）。是否继续？")){
...
function combatPlayerAction(action){
  ...
  if(action==="defend"){
    ...
    writePar("你举起武器，扎稳下盘。呼吸放缓，目光锁住对方的肩线——那是发力的前兆。","noind");
