...
def load_checks():
    ...
    from checks import c_syntax, c_links, c_refhealth, c_nodes, c_markers, c_structure, c_text, c_save, c_dead, c_speed, c_dialog, c_chunks, c_world, c_war, c_narr, c_cast, c_lore, c_ui, c_v68ui, c_causality, c_pace, c_textguard
    return {
        'quick': [
            ('语法检查', c_syntax.run),
            ('死链检查', c_links.run),
