...
m = re.search(r'window\.STORY_BLUEPRINT\s*=\s*\{', h)
print('def at:', m.start() if m else None)
if not m:
    sys.exit(1)
i = h.index('{', m.start())
